...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/mint
image:
  path: wc:English_botany%2C_or%2C_Coloured_figures_of_British_plants_%281863%29_%2814784245103%29.jpg
---
...
{% include embed/image.html src="wc:Mentha_aquatica_06_ies.jpg" caption="Mentha aquatica, water mint" aspect="1.14" class="right" %}
{% include embed/image.html src="wc:Mentha_x_piperita_002.JPG" caption="Mentha piperita, peppermint" aspect="0.75" class="right" %}
{% include embed/image.html src="wc:Flowers_of_the_spearmint.JPG" caption="Mentha spicata, spearmint" aspect="1.30" class="right" %}
{% include embed/image.html src="wc:Gardenology.org-IMG_2751_rbgs11jan.jpg" caption="Mentha pulegium, pennyroyal" aspect="1.33" class="right" %}
...
{% include embed/map.html center="30.14124,6.32813" zoom="1" basemap="Esri_WorldPhysical" caption="Distribution of Mentha" geojson="globalmintdis.geojson~Global" class="right" %}
...
{% include embed/image.html src="AWARBURGIG_10311762574_minthe.jpg" aspect="1.23" class="right" %}
...
{% include embed/map.html center="37.506267,21.862627" zoom="5" basemap="Esri_WorldPhysical" caption="Greece" markers="" class="right" %}
...
{% include embed/image.html src="wc:Gela_Painter_-_Black-Figure_%22Pinax%22_(Plaque)_-_Walters_48225.jpg" aspect="1.63" class="right" %}
...
{% include embed/image.html src="5af078d29f16830c5724f179b4beb33d515d7b64c56e03062f6737a07bc4dd4b339f9aefdef459ddebadfff555bbd0993bc3bbbda7b36d.jpg" aspect="0.7" class="right" %}
{% include embed/image.html src="pennyroyalwaterwellcome.jpg" aspect="0.66" class="right" %}
...
{% include embed/image.html src="56877891.jpg" aspect="0.67" class="right" %}
...
{% include embed/image.html src="56599909.jpg" region="0,1180,2075,1732" aspect="0.69" class="right" %}
{% include embed/image.html src="51906062.jpg" aspect="0.72" class="right" %}
{% include embed/image.html src="56599908.jpg" region="516,360,1201,1470" aspect="0.66" class="right" %}
{% include embed/map.html center="51.520201,-0.125315" zoom="4" basemap="Esri_WorldPhysical" caption="World" aspect="1" geojson="BritainYellow.geojson" class="right" %}
...
{% include embed/image.html src="wc:English_botany,_or,_Coloured_figures_of_British_plants_(1863)_(14784245103).jpg" aspect="0.64" class="right" %}
...
{% include embed/image.html src="menthaWellcome1.jpg" aspect="0.63" class="right" %}
{% include embed/image.html src="MenthaArvensisSowerby.jpg" aspect="0.62" class="right" %}
{% include embed/image.html src="pennyroyal%26thymeWellcome.jpg" aspect="0.66" class="right" %}
...
{% include embed/map.html center="42.566426,-71.751354" zoom="4" basemap="Esri_WorldPhysical" caption="New England" aspect="1" markers="" class="right" %}
{% include embed/image.html src="wc:Brewster_Gardens_Along_Town_Brook;_Statue_The_Pilglim_Maiden,_Plymouth,_Mass_(NYPL_b12647398-79392).tiff" aspect="1.48" class="right" %}
...
{% include embed/image.html src="wc:Mentha_×_piperita_-_Köhler–s_Medizinal-Pflanzen-095.jpg" caption="Peppermint from Franz Eugen Köhler, Köhler's Medizinal-Pflanzen, 1897" aspect="0.76" class="right" %}
...
{% include embed/map.html center="37.92057,-41.78272" zoom="2.5" basemap="Esri_WorldPhysical" caption="World" geojson="mintBrUSline.geojson|13colonies.geojson~Original 13 colonies" class="right" %}
...
{% include embed/map.html center="39.23011,-74.88281" zoom="4" basemap="Esri_WorldPhysical" caption="New England" geojson="13colonies.geojson" class="right" %}
...
{% include embed/image.html src="wc:01033B.jpg" caption="Triunfo mints, 20th century" aspect="1.34" class="right" %}
{% include embed/image.html src="wc:Candy_cane_William_B_Steenberge_Bangor_NY_1844-1922.jpg" caption="A Christmas card image of candy canes from the early 1900s" aspect="0.66" class="right" %}
...
{% include embed/map.html center="32.39472,-96.15234" zoom="3" basemap="Esri_WorldPhysical" caption="World" geojson="mintNamerica.geojson|mint/lineofmint.geojson" class="right" %}
...
{% include embed/map.html center="30.486795,88.475136" zoom="4" basemap="Esri_WorldPhysical" geojson="chinaIndia.geojson" class="right" %}
...
{% include embed/image.html src="3864989885_a902bf7699_h.jpg" aspect="1.51" class="right" %}
...
{% include embed/map.html center="34.8857,4.21875" zoom="1" basemap="Esri_WorldPhysical" caption="Range of mint across the world" geojson="globalmintdis.geojson~Global" class="right" %}
...
{% include embed/image.html src="wc:L._Fuchs,_De_historia_stirpium_commentarii_Wellcome_L0013945.jpg" aspect="0.63" class="right" %}
