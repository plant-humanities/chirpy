...
`youtube vid=cmpd58kMl2s caption="Mythbusters Cinnamon Challenge." .medium aspect=1.7`
...
{% include embed/image.html src="18040817.jpg" aspect="0.69" class="right" %}
...
{% include embed/image.html src="mobot31753003488159_0072.jpg" aspect="0.56" class="right" %}
{% include embed/image.html src="mobot31753000811387_0186.jpg" region="246,1762,1391,985" aspect="0.58" class="right" %}
...
{% include embed/image.html src="wc:Roman_Coin,_Denarius_of_Trajan_(FindID_963033).jpg" caption="Reverse side of a silver Roman denarius dating from the period 103-111 CE (reign of emperor Trajan), that was found in East Riding of Yorkshire, Britain." region="1414,152,1586,1031" aspect="1.87" class="right" %}
...
{% include embed/image.html src="wc:Coat_of_Arms_of_Juan_Sebastián_Elcano_A-71.svg" aspect="0.57" class="right" %}
...
{% include embed/image.html src="NL-HaNA_4.VEL_939A-groot_cropped.jpg" caption="Drawing from 1720, showing the benefits that could be made from monocultures of cinnamon on temporary cleared fields (chenas)." aspect="1.42" class="right" %}
...
{% include embed/image.html src="NL-HaNA_4.VEL_935-groot.jpg" aspect="0.37" class="right" %}
...
{% include embed/image.html src="wc:Skinning_the_cinnamon_sticks,_Ceylon,_photo_from_The_Encyclopedia_of_Food_by_Artemas_Ward.jpg" aspect="1.65" class="right" %}
{% include embed/image.html src="wc:Forming_the_cinnamon_quills,_Ceylon,_photo_from_The_Encyclopedia_of_Food_by_Artemas_Ward.jpg" aspect="1.18" class="right" %}
...
{% include embed/image.html src="mobot31753003370076_0178.jpg" aspect="1.22" class="right" %}
...
{% include embed/image.html src="wc:Francisco_de_Orellana_Amazon_River_voyage_(1541-1542).svg" caption="The expedition of Gonzalo Pizarro and Francisco de Orellana along the Amazon river, 1541–1542." aspect="" class="right" %}
...
{% include embed/image.html src="wc:Cinnamomum_verum_vs_Cinnamomum_burmanni.jpg" caption="Cinnamon quills from Cinnamomum verum (left) and C. burmanni (right)." aspect="1.22" class="right" %}
...
{% include embed/image.html src="wc:Cannelle_(Marché_de_la_Darse).jpg" caption="Cinnamon sticks for sale at the marché de la Darse, Pointe-à-Pitre, Guadeloupe." aspect="1.33" class="right" %}
...
{% include embed/image.html src="cinnamon-production-chart.jpeg" caption="Cinnamon production (all species and varieties) by the top 5 cinnamon-producing countries, 1961–2019." aspect="1.33" class="right" %}
