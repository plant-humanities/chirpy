...
published: true
featured: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/coffee
image:
...
{% include embed/image.html src="coffee-belt.png" caption="Map of the tropics, where conditions are ideal for coffee cultivation. Nina Foster, ArcGIS." aspect="1.38" class="right" %}
...
`youtube vid=faTsRV7bkEc caption="Coffee: From Farm to Cup" aspect=1.8`
...
{% include embed/image.html src="wc:Change_in_Average_Temperature_With_Fahrenheit.svg" caption="Global Warming, 1973-2023. NASA’s Scientific Visualization Studio via Wikimedia Commons." aspect="1.11" class="right" %}
...
`youtube vid=BU-0e6OLIf0 caption="The Legend of Kaldi" aspect=1.8`
...
`iframe src=https://archive.org/details/bim_eighteenth-century_a-discourse-on-coffee-i_naironus-antonius-faust_1710/page/n9?view=theater aspect=0.65`
...
{% include embed/image.html src="wc:Kaffeplantage_i_Yemen.jpg" caption="A coffee plantation in Yemen, 1762. Drawing by Georg Wilhelm Baurenfeind. Danish State Archives via Wikimedia Commons." aspect=".64" class="right" %}
...
{% include embed/image.html src="wc:Plan_du_port_de_Mocha_au_Yemen_en_1737.jpg" caption="Map of the port of Mocha used by the French East India Company in 1737. Bibliothèque nationale de France via Wikimedia Commons." aspect="1.40" class="right" %}
...
`iframe src=https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=v2%3A2PACX-1vT6Pi5o3k7Vtrj-UHyHwvY11Mw_QdQszuPBl-uMfPWou70UAv4QXTrHL_u9xFMILvZITzdMnDtHVwd0&font=Default&lang=en&initial_zoom=2&width=100%25&height=650 height=650 .full`
...
`iframe  src=https://archive.org/details/supplementtodesc1727doug/page/14?view=theater aspect=0.65`
...
{% include embed/image.html src="wc:Robert_Charles_Goff_-_Coffee_House_and_Mosque_Entrance,_Cairo_-_B1994.4.969_-_Yale_Center_for_British_Art.jpg" caption="*Coffee House and Mosque Entrance, Cairo* by Robert Charles Goff. Yale Center for British Art via Wikimedia Commons." aspect="1.42" class="right" %}
...
{% include embed/image.html src="wc:Interior_of_a_London_Coffee-house,_17th_century.JPG" caption="Interior of a London coffeehouse, 17th century. Wikimedia Commons." aspect="1.56" class="right" %}
...
{% include embed/image.html src="wc:François_Boucher_002.jpg" caption="*Le Dejeuner (Morning Coffee)* by François Boucher, 1739. Oil on canvas. Louvre Museum, Paris via Wikimedia Commons." aspect="1.81" class="right" %}
...
`youtube vid=WD6cYabx0nk caption="Coffee and Labor" aspect=1.8`
...
{% include embed/image.html src="wc:Espresso_House_in_Torp_shopping_mall,_Uddevalla.jpg" caption="A modern-day coffeehouse in Uddevalla, Sweden. W. Carter via Wikimedia Commons." aspect="1.66" class="right" %}
...
{% include embed/image.html src="wc:Manual_drip_(pour-over)_coffee.jpg" caption="Brewing coffee using the pour-over method. Kim Sanso via Wikimedia Commons." aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Coffee-farm-san-marcos-tarrazu-costa-rica.jpg" caption="Coffee farms in San Marcos, Costa Rica. Tarrazu via Wikimedia Commons." aspect="1.33" class="right" %}
...
`youtube vid=A33NTsWxc-o caption="Climate Change and Coffee Products" aspect=1.8`
...
{% include embed/image.html src="rising-temps-and-insect-pests.png" caption="Climate change generally benefits insects by promoting range expansion and boosting reproductive rates. Graphic by Nina Foster." aspect="1.78" class="right" %}
...
`image-compare before=wc:Coffee_berry_borer2.jpg after=wc:Amy_farms_typica_hybrid_coffee_beans.jpg caption="Swipe across the images to see the impact of a coffee berry borer infestation."`
...
{% include embed/image.html src="wc:Finca_La_Esperanza.jpg" caption="A coffee producer in Nicaragua inspects a coffee berry borer trap on his farm. Morgan Arnold via Wikimedia Commons." aspect="1.5" class="right" %}
...
`image-compare before=wc:Hemileia_vastatrix.jpg after=wc:Coffea_arabica_Kawa_arabska_2021-0-09_01.jpg caption="Swipe across the images to compare healthy coffee leaves with those infected by coffee leaf rust."`
...
`youtube vid=4VePbuE9iIk caption="Global Coffee Prices Rise as Drought Hits Brazil" aspect=1.8`
...
{% include embed/image.html src="coffee-stakeholders.png" caption="Some of the stakeholders in the coffee industry. Graphic by Nina Foster." aspect="1.19" class="right" %}
...
{% include embed/image.html src="wc:Coffee_farmer_-_triangulo_del_café.jpg" caption="A farmer in Colombia harvests ripe coffee berries. Maria del Pilar Ruiz via Wikimedia Commons." aspect="1.5" class="right" %}
...
`youtube vid=fmBDZKOdbkY caption="Climate Adaptation and Mitigation" aspect=1.8`
...
{% include embed/image.html src="wc:Coffee_tree_atop_the_Maricao_mountains_in_Puerto_Rico_(5661610485).jpg" caption="A coffee tree in bloom at high elevation in Puerto Rico. US Fish and Wildlife Service via Wikimedia Commons." aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Café_bajo_sombra_-_49465736457.jpg" caption="Coffee growing in an agroforestry system in Puebla, Mexico. Feria  de Productores via Wikimedia Commons." aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:DNA_Extraction_of_Bacteria.jpg" caption="Researchers extracting bacterial DNA. Iris Marie Kelly via Wikimedia Commons." aspect="1.33" class="right" %}
...
`youtube vid=xahFgSSLonQ caption="Coffee Breeding" aspect=1.8`
...
{% include embed/image.html src="wc:Coffea_stenophylla-Jardin_botanique_de_Berlin_(1).jpg" caption="*Coffea stenophylla* in the Berlin Botanic Garden. Ji-elle via Wikimedia Commons." aspect="1.67" class="right" %}
...
{% include embed/image.html src="wc:Coffee_seedlings_produced_by_Asencio_Sánchez_(5662148216).jpg" caption="Coffee seedlings in Puerto Rico. US Fish and Wildlife Service via Wikimedia Commons." aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Ethiopia's_Bale_Mountains_(MODIS_2021-01-19).jpg" caption="Aerial photo of Ethiopia’s Bale Mountains National Park, home to one of the largest natural stands of wild coffee genetic stock. NASA GSFC via Wikimedia Commons." aspect="1.3" class="right" %}
...
{% include embed/image.html src="countries-with-ex-situ-field-collections.png" caption="Countries with *ex situ* field collections of coffee. Nina Foster, ArcGIS." aspect="1.38" class="right" %}
...
{% include embed/image.html src="wc:CIAT_genebank_(6918515038).jpg" caption="A researcher at the International Center for Tropical Agriculture genebank. Luigi Guarino via Wikimedia Commons." aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Coffee_and_Friends_(Unsplash).jpg" caption="Coffee is an agent of connection. Nathan Dumlao via Wikimedia Commons." aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Harvesting_coffee,_Sao_Paulo,_Brazil,_photo_from_The_Encyclopedia_of_Food_by_Artemas_Ward.jpg" caption="Coffee farmers in Sao Paulo, Brazil, 1923. Artemas Ward via Wikimedia Commons." aspect="1.41" class="right" %}
...
{% include embed/image.html src="wc:Coffee_beans_in_a_farmer's_hands.jpg" caption="A handful of coffee’s cherished fruit. Wikimedia Commons." aspect="1.5" class="right" %}
