...
{% include embed/youtube.html id="faTsRV7bkEc" caption="Coffee: From Farm to Cup" aspect="1.8" class="right" %}
...
{% include embed/youtube.html id="BU-0e6OLIf0" caption="The Legend of Kaldi" aspect="1.8" class="right" %}
...
{% include embed/iframe.html src="https://archive.org/details/bim_eighteenth-century_a-discourse-on-coffee-i_naironus-antonius-faust_1710/page/n9?view=theater" aspect="0.65" class="right" %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=v2%3A2PACX-1vT6Pi5o3k7Vtrj-UHyHwvY11Mw_QdQszuPBl-uMfPWou70UAv4QXTrHL_u9xFMILvZITzdMnDtHVwd0&font=Default&lang=en&initial_zoom=2&width=100%25&height=650" class="right" %}
...
{% include embed/iframe.html src="https://archive.org/details/supplementtodesc1727doug/page/14?view=theater" aspect="0.65" class="right" %}
...
{% include embed/youtube.html id="WD6cYabx0nk" caption="Coffee and Labor" aspect="1.8" class="right" %}
...
{% include embed/youtube.html id="A33NTsWxc-o" caption="Climate Change and Coffee Products" aspect="1.8" class="right" %}
...
{% include embed/youtube.html id="4VePbuE9iIk" caption="Global Coffee Prices Rise as Drought Hits Brazil" aspect="1.8" class="right" %}
...
{% include embed/youtube.html id="fmBDZKOdbkY" caption="Climate Adaptation and Mitigation" aspect="1.8" class="right" %}
...
{% include embed/youtube.html id="xahFgSSLonQ" caption="Coffee Breeding" aspect="1.8" class="right" %}
