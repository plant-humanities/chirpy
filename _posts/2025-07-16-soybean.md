...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/soybean
image:
...
{% include embed/image.html src="wc:Soybean_Oil,_Meal_and_Beans_(10059732523).jpg" caption="Soybean Oil, Meal, and Beans" aspect="1.52" class="right" %}
...
{% include embed/iframe.html src="https://ourworldindata.org/grapher/soybean-production?tab=map" aspect="1" class="right" %}
...
{% include embed/image.html src="wc:Map_of_Manchuria.png" caption="Map of Machuria" aspect="2.28" class="right" %}
...
{% include embed/image.html src="wc:Chinese_Materia_Dietetica,_Ming;_Fermented_sauce_(jiang)_Wellcome_L0039386.jpg" caption="Chinese Materia Dietetica, Ming: Fermented sauce (jiang)" aspect="0.67" class="right" %}
...
{% include embed/image.html src="10.5555_al.ap.specimen.m0121623.jpg" caption="Glycine max" attribution="Specimen image provided courtesy of JSTOR. Source=https://plants.jstor.org/stable/10.5555/al.ap.specimen.m0121623" description="Filed as Glycine max (L.) Merr. [family FABACEAE]" aspect="0.66" class="right" %}
...
{% include embed/image.html src="wc:Li_Shizhen_portrait.jpg" caption="Portrait of Li Shizhen" aspect="0.82" class="right" %}
...
{% include embed/image.html src="wc:Engelbert_Kaempfer_cartouche.jpg" caption="Engelbert Kaempfer drawing a map of Japan" aspect="0.96" class="right" %}
...
{% include embed/map.html id="map1" center="36.800042129868956,139.04385130011642" zoom="6" class="right" %}
...
{% include embed/iframe.html src="Xlo_l2fFjpsC_PP7.png" caption="Soybeans as Human Food: Unprocessed and Simply Processed" aspect="0.7" class="right" %}
...
{% include embed/iframe.html src="https://archive.org/embed/different-uses-for-soybeans-the-henry-fords-innovation-nation" aspect="1.6" class="right" %}
...
{% include embed/image.html src="wc:Deforestation_in_the_Amazon_(46200453954).jpg" caption="Satellite Image of Cultivated Land in the Amazon" aspect="2.07" class="right" %}
...
{% include embed/image.html src="wc:Annual_CO2_emissions_from_deforestation_by_product,_Brazil.png" caption="Annual CO2 emissions from deforestation by product, Brazil." aspect="1.36" class="right" %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1Y-PnP29dMVReXsWgzIH_FONvVWvMG5LeXqpyrXAnhZA&timenav-position=bottom&hash-bookmark=false&initial-zoom=1&height=650" class="right" %}
...
{% include embed/image.html src="wc:Area_where_mesquite_trees_were_sprayed_with_an_arial_application_of_herbicide_30_years_ago_to_promote_grass_growth._(25116936075).jpg" caption="Trees 30 years after being sprayed with glyphosate" aspect="1.5" class="right" %}
...
{% include embed/iframe.html src="https://www.greenpeace.org/usa/wp-content/uploads/legacy/Global/usa/planet3/PDFs/eating-up-the-amazon-executiv.pdf" class="right" %}
-->
...
{% include embed/image.html src="farmbul1617_0001.jpg" attribution="_Soybean utilization_ by Morse, W. J. (William Joseph), 1884. Source: [Internet Archive](https://archive.org/embed/CAT87203600/page/n1/mode/1up?view=theater)." source="https://archive.org/embed/CAT87203600/page/n1/mode/1up?view=theater" aspect="0.59" class="right" %}
...
{% include embed/image.html src="13948990077_a0aea9a8ec_3k.jpg" caption="Roundup Herbicide" attribution="Photo via JeepersMedia and licensed under CC BY 2.0." source="https://live.staticflickr.com/7327/13948990077_a0aea9a8ec_3k.jpg" aspect="2/05" class="right" %}
...
{% include embed/image.html src="wc:12_pivot_irrigation-1579_(46148760615).jpg" caption="Pivot Irrigration on a Soybean Field" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Brazilian_Amazon.jpg" caption="Aerial view of the Amazon Rainforest, near Manaus, the capital of the Brazilian state of Amazonas." aspect="1.51" class="right" %}
...
<!-- page not loading
{% include embed/iframe.html src="https://data.worldbank.org/share/widget?indicators=AG.LND.AGRI.K2&locations=BR" aspect="1.5" class="right" %}
-->
