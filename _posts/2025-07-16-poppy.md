...
{% include embed/image.html src="Besler_Poppy3.jpg" caption="Papaver flor. luteo. Cornicu. latum, or Papaver purpureo color." description="Basilius Besler, 1713. Courtesy of Oak Spring Garden Foundation." class="right" %}
...
{% include embed/image.html src="wc:Roman_silver_denarius_of_Vespasian_dating_from_AD_73_(FindID_613177).jpg" class="right" %}
{% include embed/image.html src="wc:Mycenae_gold_ring.jpg" class="right" %}
{% include embed/image.html src="wc:Terracottas_from_Gazi_in_AM_Heraklion,_1300-1100_BC,_145278.jpg" class="right" %}
...
{% include embed/image.html src="sd1989_281_14,15.jpg" caption="Gold Pins with Spherical Head" description="Hittite Empire (ca. 14-13 century BC), in Central Anatolia. From the Norbert Schimmel Collection on loan to the Metropolitan Museum. Courtesy of the Metropolitan Museum of Art." license="public domain" class="right" %}
...
{% include embed/image.html src="wc:Tellus_-_Ara_Pacis.jpg" class="right" %}
...
{% include embed/image.html src="1IdaAAAAYAAJ_PA551.png" caption="The Wild Garden; Or, Our Groves & Shrubberies Made Beautiful by the ..." source="https://books.google.com/books?id=1IdaAAAAYAAJ&newbks=0&dq=wild%20gardens%20%20william%20robinson&pg=PA51&output=embed" class="right" %}
...
{% include embed/image.html src="wc-V0043635ER" description="From Wellcome collection: 'Unripe seed capsules of the opium poppy yield opium. Oil from the seeds is used in artist's paints, salad oil and soap.' Illustration found in book on vegetables and their uses." label="An Opium Poppy: Seed Capsule, Watercolor" license="public domain" class="right" %}
...
{% include embed/image.html src="wc:The_botanical_atlas_(Plate_XIII)_(7349116188).jpg" class="right" %}
...
{% include embed/image.html src="French_School_Poppy.jpg" caption="Papaver somniferum" description="Artist unknown, Pencil on paper, circa 18th century. Courtesy of Oak Spring Garden Foundation." class="right" %}
{% include embed/image.html src="Besler_Poppy_2.jpg" caption="Papaver flore multiplicipurpura scente" description="Another variety of Papaver somniferum, by Basilius Besler, 1713. Courtesy of Oak Spring Garden Foundation." class="right" %}
...
{% include embed/image.html src="speciesplantarum00clin_857_0521.jpg" class="right" %}
...
{% include embed/image.html src="wc:Poor_child's_nurse,_child_with_opium,_Punch,_1849_Wellcome_L0003359.jpg" region="170,1484,4071,3238" class="right" %}
...
{% include embed/image.html src="MR146_India_Opium_Spine.jpg" description="MCR/5/1/45, India: Economic Products: Opium, Miscellaneous Reports, Archives of the Royal Botanic Gardens, Kew" label="India: Economic Products: Opium, from the Miscellaneous Reports of the Royal Botanic Gardens, Kew" class="right" %}
...
{% include embed/image.html src="Stacking_room.jpg" description="Lithograph after Walter Stanhope Sherwill" label="A busy stacking room in the opium factory at Patna, India, 1856" license="public domain" class="right" %}
...
{% include embed/image.html src="Coleridge.jpg" description="Manuscript handwritten by Coleridge describing a 'reverie brought on by two grains of opium." label="Kubla Khan manuscript by Samuel Taylor Coleridge, completed in 1797" license="public domain" region="140,977,597,475" class="right" %}
{% include embed/image.html src="aMkNAAAAQAAJ_PA55.PNG" class="right" %}
...
{% include embed/image.html src="harpersweeklyv12bonn_0469.jpg" class="right" %}
...
{% include embed/image.html src="wc:Les_fleurs_animees_BHL15481312.jpg" class="right" %}
...
{% include embed/image.html src="MarianneNorth.jpg" description="Painting by Marianne North" label="Foliage, Flowers and Seed-Vessel of the Opium Poppy" license="CC BY-NC 4.0" region="-269,105,1347,1072" class="right" %}
...
{% include embed/image.html src="Wizard_oz.jpg" label="Cover of The Wonderful Wizard of Oz by Frank Baum" license="public domain" region="-248,113,1778,1414" class="right" %}
...
{% include embed/image.html src="EBC_apparatus.jpg" description="Consists of a tray, knife, scrapers, and pots." label="Apparatus for Opium Smoking, from RBG, Kew's Economic Botany Collection" license="Image used with permission of the Board of Trustees of the Royal Botanic Gardens, Kew" class="right" %}
...
{% include embed/image.html src="juanpoppycolombia1.jpg" label="Stained Poppy, Clack and White Pothograph and Ink" license="Image used with permission of the artist" class="right" %}
...
{% include embed/image.html src="juanpoppycolombia22.jpg" label="Judicial Triptych, Color and Black and White Prints" license="Image used with permission of the artist" class="right" %}
...
{% include embed/image.html src="Paisajedomestico.jpg" class="right" %}
