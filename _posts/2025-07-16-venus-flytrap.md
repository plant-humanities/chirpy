...
{% include embed/image.html src="Dionaea_muscipula_John_Schaefer_1_CC_BY_4.0.JPG" caption="L-R: Pitcher plant (Sarracenia purpurea), Venus flytrap (Dionaea muscipula), Sundew (Drosera capensis). Plants With Bite exhibit at the Royal Botanic Garden, Sydney, 2020." aspect="1.49" class="right" %}
...
{% include embed/map.html center="Q659400" zoom="6" caption="The Venus flytrap’s native range is limited to a roughly 50-mile radius around Wilmington, NC." geojson="flytraprange-2.json~The Venus flytrap’s native range is limited to a roughly 50-mile radius around Wilmington, NC." class="right" %}
...
{% include embed/image.html src="Dionaea_muscipula_John_Schaefer_2_CC_BY_4.0.JPG" caption="The Venus flytrap (Dionaea muscipula) in bloom, Royal Botanic Garden, Sydney, 2020." aspect="0.67" class="right" %}
{% include embed/image.html src="Justina_Davis_Nash_Grave_Julia_Mortenson_CC_BY_NC.JPG" caption="Grave of Justina Davis Nash, who remarried to Abner Nash, Governor of North Carolina during the Britain occupation of Halifax (1781). Colonial Churchyard, Halifax, North Carolina." aspect="1.33" class="right" %}
...
{% include embed/image.html src="Venus_Fly_Trap_Ellis_Oak_Spring_Garden_Foundation_Upperville_Virginia_copyright.jpg" region="0,421,3192,2590" aspect="0.66" class="right" %}
...
{% include embed/image.html src="Bartram_Nelumbo_lutea_NHML_copyright_Trustees_of_the_Natural_History_Museum_London.jpg" region="0,1873,3853,3276" aspect="0.75" class="right" %}
...
{% include embed/image.html src="alvin-record_232622-ATTACHMENT-0003.jpeg" aspect="0.83" class="right" %}
...
{% include embed/image.html src="307061.jpg" aspect="0.77" class="right" %}
...
{% include embed/image.html src="46794102.jpg" region="104,774,1437,1149" aspect="0.61" class="right" %}
...
{% include embed/image.html src="46794379.jpg" aspect="0.61" class="right" %}
...
{% include embed/image.html src="55098708.jpg" aspect="0.70" class="right" %}
{% include embed/image.html src="55098709.jpg" aspect="0.67" class="right" %}
{% include embed/image.html src="55098697.jpg" aspect="0.67" class="right" %}
{% include embed/image.html src="55098698.jpg" aspect="0.70" class="right" %}
...
{% include embed/image.html src="471202.jpg" aspect="0.58" class="right" %}
{% include embed/image.html src="471203.jpg" aspect="0.60" class="right" %}
...
{% include embed/image.html src="43441942.jpg" aspect="0.62" class="right" %}
...
{% include embed/image.html src="wc:Meyers_b8_s0980a.jpg" aspect="1.21" class="right" %}
{% include embed/image.html src="22537862.jpg" aspect="0.66" class="right" %}
...
{% include embed/image.html src="4259330.jpg" rotation="90" aspect="1.66" class="right" %}
...
{% include embed/image.html src="sealandillustrat00buel_0486.jpg" aspect="0.64" class="right" %}
...
{% include embed/map.html center="Q1558" zoom="3" caption="Introduced populations of the Venus flytrap have been established across the United States and Caribbean, and are today grown commercially worldwide." geojson="introducedrange.json" class="right" %}
...
{% include embed/image.html src="Dionaea_muscipula_John_Schaefer_3_CC_BY_4.0.JPG" aspect="1.5" class="right" %}
{% include embed/image.html src="Dionaea_muscipula_John_Schaefer_4_CC_BY_4.0.JPG" aspect="1.5" class="right" %}
{% include embed/image.html src="wc:Savage_Gardens_Exhibit_at_the_U.S._Botanic_Garden_venus_flytrap_sculpture.JPG" aspect="1.78" class="right" %}
