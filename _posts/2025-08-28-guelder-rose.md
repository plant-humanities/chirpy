...
{% include embed/map.html id="ukraine" center="50.45078729260635,30.522990497009793" zoom="6" caption="Map of Ukraine with zoom in to Kyiv." class="right" %}
...
{% include embed/map.html id="sites" center="52.69,2.2" zoom="3.8" caption="Prehistoric Sites with evidence of guelder rose usage" geojson="map_prehistoric.json" class="right" %}
...
{% include embed/map.html center="Q46" zoom="1" basemap="Esri_WorldPhysical" caption="Distribution of the guelder rose: native regions in red, introduced regions in yellow. Source: Royal Botanic Gardens, Kew." geojson="map_distribution.json" class="right" %}
