...
`header title="Guelder Rose: The Powerful Symbolism of a Plant in Ukraine and Russia" author="Anna Hogarth, Nidhish Birhade, and Matthew Turetsky" img=wc:Viburnum_opulus_%28Guelder_Rose%29_-_Flickr_-_S._Rae.jpg` 
...
`image #img1 src=wc:Київ._Монумент_Незалежності.jpg caption="The female figure that crowns this tall marble column is Berehynia, a folkloric female spirit associated with the protection of home or homeland. Image credit: Wikimedia commons." rotation=90 aspect=0.75`
...
`map #ukraine center=50.45078729260635,30.522990497009793 caption="Map of Ukraine with zoom in to Kyiv." zoom=6`
...
`map #sites center=52.69,2.2 zoom=3.8 caption="Prehistoric Sites with evidence of guelder rose usage"`
`- geojson url=map_prehistoric.json`
...
`image #img2 src=wc:Fulacht_Fiadh_at_Drombeg_Stone_Circle_County_Cork,_Ireland.jpg caption="A Fulacht Fiadt at Dromberg Stone Circle, Country Cork, Ireland. Image credit: Wikimedia Commons." aspect=1.33`
...
`map basemap=Esri_WorldPhysical center=Q46 zoom=1 caption="Distribution of the guelder rose: native regions in red, introduced regions in yellow. Source: Royal Botanic Gardens, Kew."`
`- geojson url=map_distribution.json fillColor=red`
...
{% include embed/image.html src="10.5555_al.ap.specimen.bm000558413.jpg" caption="Viburnum opulus" class="right" %}
...
{% include embed/image.html src="name_cloud.jpeg" caption="The many names of the guelder rose." aspect="1.91" class="right" %}
...
`iframe src=https://archive.org/embed/vignettesfromnat00alleuoft/page/93 caption="Vignettes from Nature by Grant Allen" .medium aspect=0.65`
...
`image #img3 src=wc:Viburnum_opulus001.jpg aspect=1.33`
...
{% include embed/image.html src="wc:Viburnum_opulus_Roseum_Kalina_koralowa_odm._płonna_2021-06-02_02.jpg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Viburnum_opulus_180050525.jpg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="guelderrose_fairies.jpg" caption="Guelder Rose Fairies from the Flowers Fairy Book by Frederick Warne. Image credit:Oak Spring Library Collection" aspect=".74" class="right" %}
{% include embed/image.html src="wc:Guelder_Roses_and_the_Venus_of_Milo,_1905.jpg" aspect=".87" class="right" %}
{% include embed/image.html src="japanese_art.jpg" caption="Art from Rutherford Alcock's article Japanese Art, documenting Japan's artwork that emphasizes the Guelder Rose's symmetry." license="open access" aspect="1.32" class="right" %}
{% include embed/image.html src="japanese_art2.jpg" caption="Japanese Art of the Guelder Rose." license="open access" aspect=".99" class="right" %}
...
{% include embed/image.html src="wc:00_0623_Red_Square_in_Moscow.jpg" aspect="1.5" class="right" %}
{% include embed/image.html src="wc:Shelf_for_Orthodox_icons_01_by_shakko.jpg" aspect="1.33" class="right" %}
{% include embed/image.html src="wc:Easter_eggs2.jpg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:%D0%A2%D0%B0%D1%80%D1%96%D0%BB%D1%8C_%D0%B4%D0%B5%D1%80%D0%B5%D0%B2%2527%D1%8F%D0%BD%D0%B0_%22%D0%A1%D0%B5%D1%80%D0%BF%D0%B5%D0%BD%D1%8C%22.jpg" caption="Petrykivka painting; a rooster stands for spiritual awakening." aspect="1.1" class="right" %}
{% include embed/image.html src="wc:Петриківка.jpg" caption="Petrykivka painting" aspect="0.75" class="right" %}
...
`youtube vid=TKGmpT1IeKA .medium aspect=1.8`
...
{% include embed/image.html src="wc:Вишиті_рушники,_Ніна_Федірко.jpg" caption="Embroidered towels dedicated to Euromaidan, created by Nina Fedirko." aspect="1.5" class="right" %}
...
{% include embed/image.html src="https://uploads3.wikiart.org/images/maria-prymachenko/red-snowball-tree-blooms-over-a-well-1982.jpg!Large.jpg" caption="Red Snowball Tree Blooms Over a Well, by Maria Prymachenko." attribution="wikiart" license="fair use" aspect="1.43" class="right" %}
{% include embed/image.html src="https://uploads4.wikiart.org/images/kateryna-bilokur/flowers-and-viburnum-1958.jpg!Large.jpg" caption="Flowers and viburnum, by Kateryna Bilokur, 1958." attribution="wikiart" license="fair use" aspect="1.19" class="right" %}
...
{% include embed/image.html src="wc:Mykola_Pymonenko-Zhnyva.jpg" caption="Harvest in Ukraine (oil on canvas, 1896), by Mykola Pymonenko." aspect="1.61" class="right" %}
...
{% include embed/image.html src="wc:Taras_Shevchenko_-_portrait_by_Ivan_Kramskoi.jpg" caption="Taras Shevchenko." aspect=".78" class="right" %}
...
{% include embed/image.html src="Flute1.jpg" caption="Mural depicting the Guelder Rose Flute in a hotel lobby in Kalyta, Kyviv Region. Designed by the Ukrainian Artist Ivan Valentyn Zadorozhnyi." aspect=".97" class="right" %}
{% include embed/image.html src="Flute2.jpg" caption="Mural depiciting the guelder rose flute in a hotel lobby in Kalyta, Kyviv Region. Designed by the Ukrainian Artist Ivan Valentyn Zadorozhnyi." aspect="1.47" class="right" %}
...
{% include embed/image.html src="wc:Oksana_Zabuzhko-_%E2%80%98Ukrainians_are_fighting_to_free_Europe_from_the_spectre_of_totalitarianism%E2%80%99_-_51926303269.jpg" caption="Oksana Zabuzkho is a contemporary Ukrainian Author whose work has been celebrated for its depiction of Ukrainian women. She is a recipient of the Schevchenko National Price, the highest state prize of Ukraine for works of culture & arts" aspect="1.5" class="right" %}
...
{% include embed/image.html src="Kozak_bandyryst.jpg" caption="Cossacks are a key figure of Ukraine's cultural identity & heritage. This painting by Feder Stovbynenko from 1890 depicts Cossack Mamay, a Ukrainian Folkloric Hero. Wikimedia Commons." aspect=".93" class="right" %}
{% include embed/image.html src="avers.png" caption="This coin issued in Ukraine in 2022 shows Cossack soliders lifting a falling Guelder Rose Tree. Wikimedia Commons." aspect="1" class="right" %}
...
`youtube vid="FAT3G-1mdBw" aspect=1.8`
...
`youtube vid=a-RLbCXVvwI aspect=1.8`
...
{% include embed/image.html src="wc:Ой,_у_лузі_червона_калина.jpg" caption="Lyrics of Chervona Kalyna from 1922." aspect="1.14" class="right" %}
...
`iframe src=https://ourworldindata.org/grapher/number-of-refugees-per-100000?tab=chart&country=OWID_WRL~Europe+%28UN%29~UKR .medium aspect=0.7`
...
{% include embed/image.html src="wc:Map_of_Ukraine,_with_Russian-occupied_regions_highlighted.svg" caption="The striped region shows the 2014 Russian invasion of Crimea as well as the locations of some of the heaviest fighting since 2022 along Ukraine's border." aspect="1.49" class="right" %}
...
`iframe src=https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1k6u-Y-cDqx49yJXEzKm5r1T8AJobz1PDbmmX2G6kLTg&timenav-position=bottom&hash-bookmark=false&initial-zoom=1&height=650 height=650px .center`
...
{% include embed/image.html src="wc:%D0%94%D0%B5%D1%80%D0%B6%D0%B0%D0%B2%D0%BD%D0%B8%D0%B9_%D0%B3%D1%96%D0%BC%D0%BD_%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%B8.pdf" caption="Sheet music of Ukraine's Official National Anthem, 'Ukraine Glory and Freedom.' Chervona Kalyna has been deemed an unofficial national anthem." aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Flag_of_the_President_of_Ukraine.svg" caption="The official President's Flag of Ukraine. Around the perimeter of the flag is guelder rose ornament." cover="None" aspect="1" class="right" %}
