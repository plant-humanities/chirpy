...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/tamarind
image:
...
{% include embed/image.html src="tamarind_leaves_Flicker_CC_BY_SA_2.0.png" caption="Tamarind leaves, 2010. Jyothish Kumar P.G, Flickr, CC BY-SA 2.0." region="1,64,823,749" aspect="1.78" class="right" %}
...
<!-- image not found
{% include embed/image.html src="https://www.rct.uk/sites/default/files/collection-online/3/b/519410-1424804520.jpg" caption="Tamarind Tree in Saras Baug, Pune, c.1870, albumen print, 18.9 x 24.0 cm, Royal Collection Trust/©Her Majesty Queen Elizabeth II 2020" class="right" %}
-->
...
{% include embed/map.html center="-0.70311,10.54688" zoom="1" basemap="Esri_WorldGrayCanvas" geojson="Tamarind_map.json" class="right" %}
...
{% include embed/image.html src="wc:Nallur_tamarind1.jpg" caption="Old tamarind tree, Nallur heritage grove, Bangalore, India, 2018." aspect="1.33" class="right" %}
...
{% include embed/image.html src="Babur_supervising_laying_out_Victoria_Albert_Mus_copyright_Victoria_Albert_Museum.jpg" aspect="0.77" class="right" %}
{% include embed/image.html src="wc:Shalimar_garden_1.JPG" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:(Tamarindus_indica,L.).,_da_Coleção_Brasiliana_Iconográfica.jpg" caption="Jose Joaquim Freire, Tamarindus indica, L., 1700s, watercolor, 34.5 x 24 cm." aspect="0.71" class="right" %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1N898HvO8a50-MMGVxGCR-MGbd6ftuk7b&timenav-position=bottom&hash-bookmark=false&initial-zoom=1&height=650" class="right" %}
...
{% include embed/image.html src="wc:Naturalis_Biodiversity_Center_-_L.0939530_-_Bernecker,_A._-_Tamarindus_indica_Linnaeus_-_Artwork.jpeg" aspect="1.23" class="right" %}
{% include embed/image.html src="10.5555_al.ap.specimen.linn-hs78-1-3.jpg" caption="Tamarindus indica" attribution="Specimen image provided courtesy of JSTOR. Source=https://plants.jstor.org/stable/10.5555/al.ap.specimen.linn-hs78-1-3" description="Filed as Tamarindus indica L. [family FABACEAE]" aspect="0.64" class="right" %}
...
{% include embed/image.html src="b28125800_0001_0057.jpg" aspect="0.6" class="right" %}
{% include embed/image.html src="wc:Idital_Wall_Painting.jpg" aspect="2.13" class="right" %}
...
{% include embed/image.html src="tamarind_pod_Nat_Ag_Lib_public_domain.png" caption="Amanda Almira Newton, Tamarindus indica (Indian tamarind), 1908, watercolor, 15 x 24 cm." aspect="0.64" class="right" %}

{% include embed/image.html src="wc:Burmese_Kammavaca_Manuscript.jpg" caption="Burmese Kammavaca Manuscript, 19th century." aspect="4" class="right" %}
...
{% include embed/image.html src="container_strawbery_banke_copyright_Strawbery_Banke_Museum_2017.jpeg" aspect="0.75" class="right" %}
...
{% include embed/image.html src="wc:Tamarind_(marketed).jpg" caption="Tamarind (Tamarindus indica) pods and pulp for sale at a market, Baubau City, Buton Island, Indonesia, 2012." aspect="0.75" class="right" %}
{% include embed/image.html src="wc:Tamarind_paste.jpg" caption="Jarred tamarind paste, 2018." aspect="1.40" class="right" %}
{% include embed/image.html src="wc:Puliyogare_Or_Tamarind_Rice.jpg" caption="Puliyogare (Tamarind Rice), a popular South Indian dish, 2021." aspect="1" class="right" %}
...
{% include embed/youtube.html id="pXtKAmhKdpI" aspect="1.6" class="right" %}
...
{% include embed/image.html src="LSW_RBGM_MN_CD3_279-001.jpg" aspect="1.46" class="right" %}
...
{% include embed/image.html src="b21528640_0174.jpg" aspect="0.63" class="right" %}
...
{% include embed/image.html src="b11916606_V0019937-LS-LS.jpg" aspect="0.71" class="right" %}
...
{% include embed/image.html src="2015.336370.Amish-O_0006.jpg" aspect="0.65" class="right" %}
...
{% include embed/image.html src="wc:Bo-Kaap_Cape_Town_South_Africa.jpg" caption="Bo-kaap, the old Malay quarter of Cape Town, South Africa, with Signal Hill behind the colorful homes." aspect="1.78" class="right" %}
...
{% include embed/image.html src="CHSDM-37ED16A7EC7B2-000001.jpg" caption="Frederic Edwin Church, Indian Tamarind Trees in Jamaica, 1865, graphite on green-gray wove paper, 26.2 x 25.4 cm (sheet)." attribution="Cooper Hewitt, Smithsonian Design Museum" license="CC0" aspect="0.99" class="right" %}
...
{% include embed/image.html src="sweet_tamarind_seeds_Flicker_CC_BY_NC_ND_2.0.png" caption="Sweet tamarind, 2007." aspect="1.33" class="right" %}
