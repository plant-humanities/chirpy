...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/cacao
image:
...
{% include embed/image.html src="bm000589107.jpg" aspect="0.66" class="right" %}
...
{% include embed/image.html src="wc:Friedrich_Gottlob_Hayne14.jpg" caption="Botanical illustration of _Theobroma cacao_ by Friedrich Guimpel (~1805-1846)" aspect="0.88" class="right" %}
...
{% include embed/image.html src="us00102185.jpg" aspect="0.79" class="right" %}
...
{% include embed/image.html src="wc:Badianus_Codex;_photograph_of_open_book_Wellcome_L0021272.jpg" cover="None" aspect="1.4" class="right" %}
{% include embed/image.html src="wc:Tlatelolco_e_iglesia_de_Santiago_Tlatelolco,_México_D.F.,_México,_2013-10-16,_DD_25.JPG" aspect="2.11" class="right" %}
...
{% include embed/image.html src="wc:Cacao_Flor.JPG" caption="Flowering cacao" cover="None" aspect="0.66" class="right" %}
{% include embed/image.html src="CacauaxochitlBadianus.jpeg" caption="Cacauaxochitl as depicted in Dumbarton Oaks's Badianus reproductions" cover="None" aspect="0.58" class="right" %}
{% include embed/image.html src="wc:Cacao_-_United_States_Botanic_Garden,_Washington,_D.C._-_Sarah_Stierch.jpg" caption="Fruiting cacao." cover="None" aspect="0.75" class="right" %}
{% include embed/image.html src="TlapalcacautlBadianus.jpeg" caption="Tlapalcacauatl as depicted in Dumbarton Oaks's Badianus reproductions" cover="None" aspect="0.53" class="right" %}
{: data-target="300"}
...
{% include embed/image.html src="wc:Mayan_-_Lidded_Vessel_-_Walters_20092039_-_Side_B.jpg" caption="Ancient Maya Cacao Beverage Vessel with Cacao Imagery." aspect="0.71" class="right" %}
{% include embed/image.html src="CacaoReprod.png" caption="Reproductive Life Cycle of Cacao." aspect="1.02" class="right" %}
...
{% include embed/image.html src="MilpaCycle.png" label="Milpa Cycle" aspect="1.02" class="right" %}
...
{% include embed/image.html src="CacaoVessel.jpg" caption="Early Classic Maya Bowl with Anthropomorphic Cacao Trees, curated by Dumbarton Oaks Museum." aspect="1.13387" class="right" %}
{% include embed/image.html src="wc:Pakal_the_Great_tomb_lid.png" caption="Pakal's sarcophagus detail with ancestors depicted as fruit trees." aspect="0.60" class="right" %}
...
{% include embed/image.html src="459304944.jpg" caption="Classic Maya Buenavista cylinder vase used for Cacao beverages." source="https://iiif.lib.harvard.edu/manifests/ids:459304944" aspect="0.73" class="right" %}
{% include embed/image.html src="459304936.jpg" caption="Classic Maya Buenavista cylinder vase used for Cacao beverages. - Rollout" source="https://iiif.lib.harvard.edu/manifests/ids:459304936" aspect="1.64" class="right" %}
...
{% include embed/map.html center="18.10596,-94.04924" zoom="4.5" basemap="Esri_WorldPhysical" caption="Cacao Distribution in the Mexica Empire at the Time of Contact with Europeans" geojson="Neotropics.geojson~Neotropics|Mexica.geojson~Mexica" class="right" %}
...
{% include embed/image.html src="9089.jpg" aspect="3.31" class="right" %}
{% include embed/image.html src="0631.jpg" region="367,125,784,587" aspect="1.64" class="right" %}
{% include embed/image.html src="GodLVessel.jpg" aspect="1.08" class="right" %}
...
{% include embed/image.html src="wc:Murales_Rivera_-_Treppenhaus_9_Bücherverbrennung.jpg" caption="Diego Rivera Mural depicting an Auto de Fe of indigenous literature and idols." aspect="1.33" class="right" %}
...
{% include embed/map.html center="41.50858,-18.28125" zoom="1" basemap="Esri_WorldPhysical" caption="Seville, Spain, Where Mondardes Lived and Reported his Observations of Plants" geojson="Americas_and_Europe.geojson~Americas and Europe" class="right" %}
...
{% include embed/map.html center="30.75128,-206.71875" zoom="0" basemap="Esri_WorldPhysical" caption="Movement of Cacao Across the Early Modern World" geojson="Americas_and_Europe.geojson~Americas and Europe|SirDrake.geojson~Sir Drake's Voyage" class="right" %}
...
{% include embed/image.html src="56601539.jpg" region="503,861,1701,1273" aspect="0.73" class="right" %}
{% include embed/image.html src="8066123.jpg" aspect="0.60" class="right" %}
...
{% include embed/map.html center="19.06212,-94.57031" zoom="4" basemap="Esri_WorldPhysical" caption="Girolamo Benzoni's Accounts Refer to Cacao Being Grown in Nicaragua" geojson="Neotropics.geojson~Central American Neotropics|Nicaragua.geojson~Nicaragua" class="right" %}
...
{% include embed/map.html center="29.187255,-10.812716" zoom="2" basemap="Esri_WorldPhysical" caption="Distribution of Cacao Today" aspect="1" geojson="CacaoDist.geojson~Current _Theobroma cacao_ Distribution" class="right" %}
{% include embed/image.html src="wc:Chocolate_pot_MET_131294.jpg" aspect="0.85" class="right" %}
{% include embed/image.html src="wc:Chocolate_Cup_And_Saucer_(Germany),_1735–45_(CH_18349969).jpg" caption="German chocolate cup and saucer ca. 1735-45" aspect="1.0" class="right" %}
{% include embed/image.html src="wc:Cadbury's_Cocoa_advert_with_rower_1885.jpg" aspect="0.61" class="right" %}
