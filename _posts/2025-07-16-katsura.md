...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/katsura
image:
...
{% include embed/image.html src="mcguire-beatrix-farrands-plant-book-for-dumbarton-oaks_20.jpg" aspect="0.7" class="right" %}
...
{% include embed/image.html src="closeup.jpg" caption="Close-up of the katsura tree." aspect="0.75" class="right" %}
...
{% include embed/image.html src="katsura-tree.jpg" caption="Dumbarton Oak's katsura tree in the fall showcasing its red leaves." aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Cercidiphyllum_obtritum_SRIC_SR_02-04-03_A_img1.jpg" aspect="0.96" class="right" %}
{% include embed/image.html src="10.5555_al.ap.specimen.e00313733.jpg" aspect="0.62" class="right" %}
...
{% include embed/image.html src="wc:Geppa-ro.jpg" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Shinto-Tsukuyomi-no-Mikoto-Old-Artwork.png" aspect="0.59" class="right" %}
...
{% include embed/image.html src="02433_2004_001_a.jpg" caption="Treaty of Kanagawa, in English March 31, 1854 Record Group 11 General Records of the United States Government" aspect="0.61" class="right" %}
...
{% include embed/image.html src="Pierce.png" caption="Clipping of a newspaper showing a Peirce ad. The Madisonian.(Washington City [i.e. Washington, D.C.]), 25 March 1841. Chronicling America: Historic American Newspapers. Lib. of Congress." aspect="0.72" class="right" %}
...
{% include embed/iframe.html src="gardenersmonthly21meeh_0083.jpg" aspect="0.7" class="right" %}
...
{% include embed/image.html src="485971684.jpg" caption="1922 topographical survey of Dumbarton Oaks." source="https://iiif.lib.harvard.edu/manifests/ids:485971684" aspect="0.83" class="right" %}
...
{% include embed/image.html src="installation.jpg" caption="Halfway point of hoozue installation." aspect="1.5" class="right" %}
...
{% include embed/image.html src="hoozue.jpg" caption="Left to right: single pole hoozue, bridge hoozue, and heavy support hoozue" aspect="1.33" class="right" %}
...
{% include embed/image.html src="KatsuraDO.jpg" caption="Dumbarton Oaks' katsura tree." aspect="1.5" class="right" %}
