...
{% include embed/image.html src="56601375.jpg" aspect="0.73" class="right" %}
...
{% include embed/map.html center="49.408,-63.531" zoom="5" basemap="Esri_WorldPhysical" caption="Gulf of Saint Lawrence" markers="Q3339246" geojson="cartier.json" class="right" %}
...
{% include embed/map.html center="Q544356" zoom="5.5" basemap="Esri_WorldPhysical" caption="Gulf of Saint Lawrence" geojson="St_Lawrence_Iroquoians.json" class="right" %}
...
{% include embed/map.html center="48.402,2.7003" zoom="4.5" basemap="Esri_WorldPhysical" caption="Locations where accounts of Cartier's expeditions were published." geojson="cartier_publishing.json" class="right" %}
...
{% include embed/image.html src="nebc00056528.jpg" aspect="0.69" class="right" %}
{% include embed/image.html src="a00022322.jpg" aspect="0.69" class="right" %}
{% include embed/image.html src="a00022346.jpg" aspect="0.70" class="right" %}
{% include embed/image.html src="l0820001.jpg" aspect="0.58" class="right" %}
{% include embed/image.html src="linn-hl1136-1.jpg" aspect="0.81" class="right" %}
...
{% include embed/map.html center="Q2145" zoom="3" basemap="Esri_WorldPhysical" markers="Q2145" geojson="ThujaDistribution.json" class="right" %}
...
{% include embed/map.html center="42.655,-74.715" zoom="3.5" basemap="Esri_WorldPhysical" caption="Thuja Distribution" geojson="ThujaDistribution.json" class="right" %}
...
{% include embed/map.html center="42.655,-74.715" zoom="4" basemap="Esri_WorldPhysical" geojson="Maritime_Indians.json" class="right" %}
...
{% include embed/map.html center="Q544356" zoom="6" basemap="Esri_WorldPhysical" caption="Territory occupied by the St. Lawrence Iroquoians, circa 1535" geojson="St_Lawrence_Iroquoians.json~St. Lawrence Iroquoians" class="right" %}
...
{% include embed/image.html src="wc:A_case_of_Scurvy_journal_of_Henry_Walsh_Mahon.jpg" aspect="0.63" class="right" %}
...
{% include embed/image.html src="Vitamin_C_in_conifers.jpg" aspect="1.01" class="right" %}
...
{% include embed/map.html center="48.402,2.700" zoom="10" caption="France" aspect="1" class="right" %}
{% include embed/image.html src="wc:Fontainebleau_bird%27s_eye_view.jpg" aspect="0.74" class="right" %}
...
{% include embed/map.html center="48.402,2.7" zoom="5" basemap="Esri_WorldPhysical" geojson="arbor_vitae_publishing.json" class="right" %}
...
{% include embed/map.html center="45.9034,14.814" zoom="3.5" basemap="Esri_WorldPhysical" geojson="thuja_in_europe.json" class="right" %}
...
{% include embed/image.html src="56601375.jpg" aspect="0.73" class="right" %}
{% include embed/image.html src="529649.jpg" aspect="0.61" class="right" %}
{% include embed/image.html src="49828508.jpg" aspect="0.68" class="right" %}
{% include embed/image.html src="359023.jpg" aspect="0.60" class="right" %}
...
{% include embed/map.html center="14.9963,6.7126" zoom="2" basemap="Esri_WorldPhysical" caption="Territory of the First French Empire (blue) and Second French Empire (light blue)" geojson="French_Empire.json" class="right" %}
...
{% include embed/map.html center="Q48335" zoom="5" basemap="Esri_WorldPhysical" caption="Newfoundland" geojson="Newfoundland.json" class="right" %}
...
{% include embed/map.html center="52.282,-5.244" zoom="5" basemap="Esri_WorldPhysical" caption="Journey of the HMS Salisbury" geojson="Lind.json" class="right" %}
...
{% include embed/map.html center="41.727,-45.853" zoom="3" basemap="Esri_WorldPhysical" geojson="custom.geo(1).json" class="right" %}
