...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/agave
image:
...
{% include embed/image.html src="Aloe_Americana_Leiden_DO.jpg" aspect="0.75" class="right" %}
...
{% include embed/map.html center="25.503945,-102.834000" zoom="4" basemap="Esri_WorldPhysical" caption="Agave americana distribution" markers="Q13160|Q170603" geojson="agave_distribution.json" class="right" %}
...
{% include embed/image.html src="https://tile.loc.gov/image-services/iiif/service:gdc:gdcwdl:wd:l_:10:62:2:wdl_10622:MedPalat220_03_0656/full/pct:25/0/default.jpg" caption="Treating a head wound. Bernardino De Sahagún, Book XI, Historia general de las cosas de Nueva España (Florentine Codex), 1577. Biblioteca Medicea Laurenziana via World Digital Library, public domain." region="422,1352,592,542" aspect="0.76" class="right" %}
...
{% include embed/image.html src="wc:Codex_Magliabechiano_%28folio_79r%29.jpg" region="188,157,826,636" aspect="1.39" class="right" %}
{% include embed/image.html src="wc:Codex_Magliabechiano_%28folio_85r%29.jpg" region="204,22,765,589" aspect="1.39" class="right" %}
...
{% include embed/image.html src="tumblr_nzbju0LvFn1ssxmhoo1_1280.jpg" aspect="0.67" class="right" %}
...
{% include embed/image.html src="6781301.jpg" aspect="0.65" class="right" %}
...
{% include embed/image.html manifest="Clusius_Network.jpg" aspect="1.47" class="right" %}
...
{% include embed/map.html center="Q2468128" zoom="1.5" markers="Q13160" class="right" %}
...
{% include embed/image.html src="wc:Agave_roasting_pit_1.jpg" aspect="1.50" class="right" %}
{% include embed/image.html src="Caschuin-pit-for-Ancestral--tequila.jpg" caption="Agave hearts in a roasting pit. Long Island Lou Tequila." source="https://longislandloutequila.com/content/images/2017/02/Caschuin-pit-for-Ancestral--tequila.jpeg" aspect="1.33" class="right" %}
...
{% include embed/map.html center="Q13160" zoom="5" basemap="Esri_WorldPhysical" caption="Jalisco, Mexico" markers="Q13160|Q170603" class="right" %}
...
{% include embed/image.html src="wc:Agave-Fields.jpg" caption="Agave as biofuel" aspect="1.25" class="right" %}
