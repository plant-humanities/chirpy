...
{% include embed/map.html center="Q18748726" zoom="11" geojson="/corpse_flower.json" class="right" %}
{% include embed/image.html src="Kew_historic_Corpse_Flower.jpg" caption="Corpse Flower Bloom, Kew, 1901" aspect="1.7" class="right" %}
...
{% include embed/map.html center="Q636275" zoom="14" geojson="corpse_flower.json" class="right" %}
...
{% include embed/map.html center="51.6148,0.11231" zoom="0.8" basemap="Esri_WorldGrayCanvas" geojson="corpse-flower-bloom.json" class="right" %}
...
{% include embed/map.html center="Q13375" zoom="4" geojson="first_botanic_gardens.json" class="right" %}
...
{% include embed/image.html src="iunc_CF.jpg" caption="IUNC Red List Map Extant (resident) _Amorphophallus titanum_ species 2018" aspect="1.82" class="right" %}
...
{% include embed/image.html src="mco-6927-1_1-768x768.jpg" caption="Mark Hachadourian with a Corpse Flower at the NYBG" source="https://www.nybg.org/content/uploads/2018/06/mco-6927-1_1-768x768.jpg" aspect="1" class="right" %}
