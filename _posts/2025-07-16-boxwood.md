...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/boxwood
image:
  path: wc:Gew%C3%B6hnlicher_Buchsbaum%2C_Buxus_sempervirens_.JPG
---
...
{% include embed/map.html center="39.812733,-97.042653" zoom="3" caption="Occurence of boxwood blight in America, 2010–2018." geojson="us-states.json~Boxwood in US" class="right" %}
...
{% include embed/image.html src="box-walk.jpg" region="154,53,900,667" aspect="1.50" class="right" %}
...
{% include embed/map.html center="38.914468,-77.062895" zoom="17.8" caption="Dumbarton Oaks garden." geojson="box-walk.json~Walk|box-terrace.json~Terrace|box-ellipse.json~Ellipse" class="right" %}
...
{% include embed/map.html center="47.192704,23.108475" zoom="3" caption="Native European distribution of common boxwood (_Buxus sempervirens_)." geojson="Buxus_sempervirens_plg.json~Places|Buxus_sempervirens_pnt.json~Places" class="right" %}
...
{% include embed/image.html src="wc:Entrance_of_Castle_Middachten_with_nice_Buxus_garden_-_panoramio.jpg" aspect="1.51" class="right" %}
{% include embed/image.html src="wc:Vrtbovská_zahrada,_z_druhého_parteru.JPG" aspect="1.33" class="right" %}
{% include embed/image.html src="wc:Oldway_Mansion_03.jpg" aspect="1.63" class="right" %}
...
{% include embed/image.html src="herballorgeneral00gera_2_1251.jpg" aspect="0.6" class="right" %}
...
{% include embed/image.html manifest="https://archive.org/embed/gri_33125012606931/page/605/mode/1up" aspect="0.6" class="right" %}
 -->
...
{% include embed/image.html src="wc:Prayer_Bead_with_the_Adoration_of_the_Magi_and_the_Crucifixion_MET_DP371957.jpg" caption="Sixteenth-century Netherlandish rosary bead (exterior)." aspect="1.33" class="right" %}
{% include embed/image.html src="wc:Prayer_Bead_with_the_Adoration_of_the_Magi_and_the_Crucifixion_MET_DP371961.jpg" caption="Sixteenth-century Netherlandish rosary bead (interior)." region="109,1836,2762,2043" aspect="0.75" class="right" %}
{% include embed/image.html src="DP371962.jpg" caption="Sixteenth-century Netherlandish rosary bead (interior)." region="133,185,2777,2083" aspect="0.75" class="right" %}
...
{% include embed/image.html src="47289351_10.jpg" caption="Front page of Claude Mollet (c. 1564–c. 1649), _Theatre des plans et iardinages_, 1652." source="https://iiif.lib.harvard.edu/manifests/drs:47289351 seq=10" aspect="0.77" class="right" %}
{% include embed/image.html src="47289351_238.jpg" caption="Garden design pattern, in Claude Mollet, _Theatre des plans et iardinages_, 1652, plate 5." source="https://iiif.lib.harvard.edu/manifests/drs:47289351 seq=238" aspect="0.82" class="right" %}
...
{% include embed/map.html center="Q90" zoom="8" caption="French royal gardens where Claude Mollet experimented with boxwood." class="right" %}
...
{% include embed/image.html src="wc:Villa_i_tatti,_ext.,_giardino_05.JPG" caption="Boxwood pattern in the gardens of Villa I Tatti." aspect="1.33" class="right" %}
{% include embed/image.html src="wc:Bernard_Berenson_in_the_gardens_of_Villa_I_Tatti.jpg" caption="Bernard Berenson in the gardens of Villa I Tatti." aspect="1.39" class="right" %}
...
{% include embed/image.html src="Boxwood-blight-in-Dumbarton-Oaks-garden_pre-removal1.jpg" aspect="1.33" class="right" %}
{% include embed/image.html src="Boxwood-blight-in-Dumbarton-Oaks-garden_pre-removal2.jpg" aspect="1.33" class="right" %}
{% include embed/image.html src="Boxwood-blight-in-Dumbarton-Oaks-garden_post-removal.jpg" aspect="1.33" class="right" %}
