...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/peanut
image:
  path: wc:A_Peanut_Plant%2C_illustration_from_The_Encyclopedia_of_Food_by_Artemas_Ward_01.jpg
---
...
{% include embed/map.html center="17.97738,21.09375" zoom="1" basemap="Esri_WorldPhysical" caption="The distribution of Arachis hypogaea around the world, with its native range shown in orange." geojson="distributionmap_native_introduced.json~Distribution and native range of Arachis hypogaea." class="right" %}
...
{% include embed/map.html id="distribution" center="-18.31213,-24.96094" zoom="2" basemap="Esri_WorldPhysical" caption="The distribution of Arachis hypogaea around the world, with its native range shown in orange." markers="" geojson="peanutdistributionmap.json~Distribution of Arachis hypogaea (yellow)." class="right" %}
...
{% include embed/map.html id="tenochtitlan" center="-1.76453,-42.1875" zoom="2" basemap="Esri_WorldPhysical" caption="Tenochtitlan, the location of present-day Mexico City." markers="" geojson="peanutdistributionmap.json~Distribution of Arachis hypogaea (yellow)." class="right" %}
...
{% include embed/image.html src="iiif-service_gdc_gdcwdl_wd_l__10_62_2_wdl_10622_MedPalat220_03_0598-full-pct_100-0-default.jpg" caption="Peanut plant, Bernardino De Sahagún, Book XI, Historia general de las cosas de Nueva España (Florentine Codex), 1577, Biblioteca Medicea Laurenziana via World Digital Library, public domain." source="https://tile.loc.gov/image-services/iiif/service:gdc:gdcwdl:wd:l_:10:62:2:wdl_10622:MedPalat220_03_0598/full/pct:100/0/default.jpg" region="1483,3504,3083,2688" aspect="0.76" class="right" %}
...
{% include embed/map.html id="china-spread" center="24.187,89.046" zoom="3" basemap="Esri_WorldPhysical" caption="Spread of peanuts to China." markers="" geojson="traderoutesmap.json" class="right" %}
...
{% include embed/image.html src="met-44155_196170.jpg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="yearbook189500unit_0206.jpg" aspect="0.58" class="right" %}
...
{% include embed/image.html src="wc:18660509_Goober_Peas_-_lyrics_-_Thomasville_Southern_Enterprise_(Georgia).jpg" caption="Lyrics of the folk song “Goober Peas,” printed in Southern Enterprise, Thomasville, Georgia, U.S., May 9, 1866." aspect="1.08" class="right" %}
...
{% include embed/image.html manifest="https://ids.si.edu/ids/manifest/NPG-NPG_92_156Carver-000001" caption="Clifton Johnson, George Washington Carver, Alabama, c.1900, gelatin silver print, 17.3 x 12.3 cm (sheet), National Portrait Gallery, Smithsonian Institution." class="right" %}
-->
...
{% include embed/image.html src="Dr_George_Washington_Carver_US_Depart_Ag_Flickr_public_domain.jpg" caption="Dr. George Washington Carver, Tuskegee University, Alabama, September 1938, U.S. Department of Agriculture. Public domain. Photo Courtesy National Archives and Records Administration." aspect="0.92" class="right" %}
...
{% include embed/image.html src="stnicholasserial4721dodg_0742.jpg" class="right" %}
...
{% include embed/image.html src="harpersweeklyv14bonn_0463.jpg" class="right" %}
...
{% include embed/youtube.html id="essMVyS1Om0" caption="The Peanut Vendor - Don Azpiazu (Antonio Machin, vocal), 1931, the78prof, YouTube." aspect="1.6" class="right" %}
...
{% include embed/image-compare.html before="wc:A_Peanut_Plant%2C_illustration_from_The_Encyclopedia_of_Food_by_Artemas_Ward_01.jpg" after="wc:Arachis_hypogaea_006.JPG" class="right" %}
