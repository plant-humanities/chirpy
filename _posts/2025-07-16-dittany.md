...
description: Used for over 2,000 years, dittany has been closely tied to women’s health,
  especially around menstruation and childbirth. This story explores how historical
  herbals and recipes reflect women’s knowledge and agency in using this medicinal
  plant across time.
...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/dittany
image:
...
{% include embed/image.html src="wc:Foetal_positions_BR_3701-15_28r.jpg" caption="Foetal positions in womb, illustration to Soranus, Gynaecia (Manuscript: Brussels, Bibliothèque Royale, ms. 3701-15, fol. 28r)" region="0,99,1078,747" aspect="0.73" class="right" %}
...
{% include embed/map.html center="33.28462,31.81641" zoom="3" geojson="dittany.json~Dittany Distribution" class="right" %}
...
<!-- broken image link
{% include embed/image.html manifest="2314efcd51a8737c56c82eebde7123aef58754a932f461508100d0d2ae92907f.yaml" aspect="" class="right" %}
-->
...
<!-- broken image links
{% include embed/image.html manifest="2a8d3ff777f06996b55f34312ded1dfaa6f513ef4d9ec770f15aae46843cd50a.yaml" aspect="" class="right" %}
{% include embed/image.html manifest="3d13c3c61f78f56bd9f063c11b4d82b6b3e75af49952951faee9697313541875.yaml" aspect="" class="right" %}
{% include embed/image.html manifest="7c876b6f3affb2130639db6ed6361ddcf97a767b5819cf10927c56ff090e5fe8.yaml" aspect="" class="right" %}
-->
...
{% include embed/image.html src="wc:A_woman_in_bed_recovering_from_childbirth,_a_midwife_washes_Wellcome_V0014914ER.jpg" caption="Woodcut of a woman in bed recovering from childbirth." region="26,48,1321,943" aspect="1.02" class="right" %}
...
{% include embed/image-compare.html before="35673708.jpg" after="49828671.jpg" class="right" %}
...
{% include embed/image.html src="112269.jpg" region="3495,3,2869,2393" aspect="1.29" class="right" %}
...
{% include embed/image.html src="t5VkAAAAcAAJ_PA57.jpg" aspect="0.63" class="right" %}
...
{% include embed/image.html src="5af078d29f16830c5724f778c6beb33d515d7a6fc0610e062f6737a170c1d34e339f9aefdef459ddebadfff555bbd0993bc3bba5aaaaca.jpg" aspect="0.74" class="right" %}
...
{% include embed/image.html src="57081035.jpg" aspect="0.64" class="right" %}
...
{% include embed/image.html src="aristotlesmasterpiece-1.jpg" aspect="0.67" class="right" %}
...
{% include embed/image.html src="wc:People_distilling_Wellcome_L0042112.jpg" caption="People distilling from Rösslin, Kreuterbuch, 1550" region="315,1054,918,677" aspect="" class="right" %}
