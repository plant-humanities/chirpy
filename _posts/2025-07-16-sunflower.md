...
{% include embed/image.html src="wc:Sunflower_sky_backdrop.jpg" aspect="0.90" class="right" %}
{% include embed/image.html src="wc:Helianthus_annuus_3.jpg" cover="None" aspect="0.74" class="right" %}
{% include embed/image.html src="wc:SunflowerYield.png" aspect="1.67" class="right" %}
...
{% include embed/image.html src="LINN_Critica_botanica_97-standard-scale-2_00x-gigapixel.jpg" aspect="0.67" class="right" %}
{% include embed/image.html src="LINN_Critica_botanica_98-gigapixel-standard-scale-2_00x.jpg" aspect="0.63" class="right" %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1gtN_aUHlOPEZr_APokEFgx4cJGoy4wKMha-UavmXiKk&timenav-position=bottom&hash-bookmark=false&initial-zoom=1&height=500" class="right" %}
...
{% include embed/image-compare.html before="1F33B_sunflower_OpenMojis_rectangle_3.png" after="81b2d5fbce4c498f189ec2632742dc0e062737f432cd9b428b0f12ad64b907cb.yaml" class="right" %}
...
{% include embed/image.html src="zoompage86.jpg" region="66,93,970,856" aspect="1.73" class="right" %}
{% include embed/image.html src="sunflower_Collaert_Rijksmuseum_RP-P-BI-5997.jpg" region="294,2322,2998,2383" aspect="0.72" class="right" %}
{% include embed/image.html src="mobot31753003488126_0194.jpg" aspect="0.62" class="right" %}
...
{% include embed/map.html center="Q495448" zoom="4.5" caption="Hayes Shelter prehistoric site, Marshall County, central Tennessee" class="right" %}
...
{% include embed/map.html id="map1" center="Q80914" zoom="6.5" caption="San Antonio cave, Tobasco, Mexico" class="right" %}
...
{% include embed/image.html src="wc:Anthonyvandyckselfportrait.jpeg" aspect="1.41" class="right" %}
{% include embed/image.html src="sunflower_Vianen_Rijksmuseum_RP-P-1908-3593.jpg" region="pct:51.22,45.36,28.54,30.45" aspect="0.65" class="right" %}
{% include embed/image.html src="4817_000147.jpg" aspect="1.51" class="right" %}
{% include embed/image.html src="treeoflifecomphead3.jpg" aspect="1.93" class="right" %}
...
{% include embed/youtube.html id="rjwd4DErj_M" caption="_Circadian regulation of sunflower heliotropism, floral orientation, and pollinator visits_, Hagop S. Atamian, Nicky M. Creux, Evan A. Brown, Austin G. Garner, Benjamin K. Blackman, Stacey L. Harmer, DOI: 10.1126/science.aaf9793" aspect="1.6" class="right" %}
...
{% include embed/image.html src="treeoflifecomphead3.jpg" aspect="1.93" class="right" %}
{% include embed/image.html src="wc:Helianthus_whorl.jpg" aspect="1.33" class="right" %}
{% include embed/image.html src="wc:SunflowerModel.svg" aspect="1" class="right" %}
...
{% include embed/image.html src="harvard-436574052_10.jpg" source="=https://iiif.lib.harvard.edu/manifests/drs:436574052 seq=10" aspect="0.79" class="right" %}
{% include embed/image.html src="harvard-436574052_12.jpg" source="=https://iiif.lib.harvard.edu/manifests/drs:436574052 seq=12" aspect="0.8" class="right" %}
...
{% include embed/image.html src="VINCENT-VAN-GOGH_SONNENBLUMEN_CC-BY-SA_BSTGS_8672.jpg" aspect="0.79" class="right" %}
{% include embed/image.html src="wc:Helianthus_annuus_(cultivar)_02.jpg" aspect="1.33" class="right" %}
{% include embed/image.html src="wc:Vincent_van_Gogh_-_Sunflowers_(1888,_National_Gallery_London).jpg" aspect="0.79" class="right" %}
...
{% include embed/image.html src="wc:Sunflower_%22Strawberry_Blonde%22_(3931552086).jpg" aspect="0.67" class="right" %}
{% include embed/image.html src="ind1000014.jpg" region="0,394,6823,6069" aspect="0.69" class="right" %}
{% include embed/image.html src="blh0000162.jpg" region="0,1731,6793,6042" aspect="0.69" class="right" %}
{% include embed/image.html src="e00417225.jpg" region="0,54,6144,5465" aspect="0.61" class="right" %}
...
{% include embed/image.html src="DP229743.jpg" aspect="1.41" class="right" %}
