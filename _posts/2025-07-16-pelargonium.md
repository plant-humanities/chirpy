...
{% include embed/image.html src="Charles-Dickens-with-his-daughters-Mamie-Dickens-and-Catherine-Katey-Elizabeth-Macready-Perugini-ne-Dickens.jpg" aspect="0.81" class="right" %}
{% include embed/image.html src="Pelargonium_CharlesDickensWindow_FLICKR.jpg" region="358,0,1503,1356" aspect="1.51" class="right" %}
{% include embed/image.html src="Pelargonium_CharlesDickensMuseum_FLICKR.jpg" aspect="0.67" class="right" %}
...
{% include embed/image.html src="illustriertegart08cour_0119.jpg" aspect="0.64" class="right" %}
{% include embed/image.html src="illustriertegart08cour_0121.jpg" aspect="0.67" class="right" %}
{% include embed/image.html src="wc:Scarlet_geranium.jpg" aspect="1.44" class="right" %}
...
{% include embed/image.html src="met-440729_802157.jpg" aspect="0.75" class="right" %}
{% include embed/image.html src="Pelargoniums_BowoodHouse_FLICKR.jpg" aspect="1.37" class="right" %}
{% include embed/image.html src="wc:Floriculture.jpg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="11654__Botany_U_1336491.jpeg" region="pct:42.88,14.38,47.33,45.85" aspect="0.61" class="right" %}
{% include embed/image.html src="Veronica_Matallana_The_Geraniaceae_family_Copyright_Veronica_Matallana_2020.jpg" aspect="1.35" class="right" %}
...
{% include embed/image.html src="Pelargonium_geranium_triste_COR_Canad_Pl_000126.jpg" class="right" %}
{% include embed/image.html src="wc:Pelargonium_triste_4.jpg" class="right" %}
...
{% include embed/image.html src="Pelargonium_QueenAdelaide_Europeana.jpg" aspect="0.65" class="right" %}
{% include embed/image.html src="met-DP152116.jpg" aspect="0.84" class="right" %}

<!-- image not loading
{% include embed/image.html manifest="https://www.nga.gov/api/v1/iiif/presentation/manifest.json?cultObj:id=66250" caption="Rembrandt Peale, _Rubens Peale with a Geranium_, 1801, oil on canvas, 71.4 x 61 cm" class="right" %}
-->
...
{% include embed/image.html src="on-the-growth-of-plants-in-closely-glazed-cases.jpg" aspect="0.66" class="right" %}
{% include embed/image.html src="met-DT2030.jpg" region="75,1436,2006,1590" aspect="1.20" class="right" %}
{% include embed/image.html src="nypl-835246.jpg" aspect="0.67" class="right" %}
...
{% include embed/image.html src="gardensEngland00Broo_0009.jpg" aspect="0.67" class="right" %}
{% include embed/image.html src="gardensEngland00Broo_0039.jpg" rotation="90" aspect="1.45" class="right" %}
{% include embed/image.html src="gardensEngland00Broo_0045.jpg" rotation="90" aspect="1.46" class="right" %}
{% include embed/image.html src="gardensEngland00Broo_0107.jpg" rotation="90" aspect="1.43" class="right" %}
...
{% include embed/image.html src="gm0_2002-031-1500x1005.jpg" class="right" %}
...
{% include embed/image.html src="amateursflowerga00hibb_0032.jpg" aspect="0.62" class="right" %}
{% include embed/image.html src="amateursflowerga00hibb_0031.jpg" aspect="0.62" class="right" %}
...
{% include embed/image.html src="jennysgeraniumor00bostiala_0008.jpg" aspect="0.60" class="right" %}
...
{% include embed/image.html src="Pelargonium_Chirismap_DavidRumsey.jpg" caption="Gabriel Mazuyer, Georges Lecomte, Lucien Boucher, Les etu A. Chiris s'installent dans le Monde entier, 1931, published by Antoine Chiris, Paris, from David Rumsey Historical Map Collection. David Rumsey Historical Map Collection, CC BY-NC-SA 3.0." aspect="1.03" class="right" %}
...
{% include embed/image.html src="Chiris_Factory.png" caption="Pelargonium fields and floricultural industry, Algeria. Anonymous, no publication date [1900s-1910s?], black and white photograph from glass plate" attribution="Source gallica.bnf.fr / BnF" aspect="1.35" class="right" %}
{% include embed/image.html src="10.5555_al.ap.specimen.k000417315.jpg" aspect="0.70" class="right" %}
...
{% include embed/image.html src="Tianzhu_Kui.png" aspect="0.80" class="right" %}
...
{% include embed/image.html src="Pelargoniums_RP-F-2013-85-14.jpg" aspect="0.77" class="right" %}
{% include embed/image.html src="Blondelet_Eugène_btv1b6904421n.jpg" aspect="0.73" class="right" %}
{% include embed/image.html src="CAT31291276_0036.jpg" rotation="270" aspect="0.73" class="right" %}
