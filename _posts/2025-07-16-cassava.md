...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/cassava
image:
  path: banner.jpg
---
...
{% include embed/image.html src="wc:Cassava_ap_001.JPG" caption="Cassava field near Bondoukou, north-eastern Ivory Coast, September 2014." cover="None" aspect="1.38" class="right" %}
{% include embed/image.html src="Cassava_distribution_map_4.jpg" caption="Global distribution of cassava. Cassava’s native habitat is marked in green, and regions where cassava was introduced by humans are marked in orange." region="2124,680,2903,1968" aspect="1.98" class="right" %}
...
{% include embed/map.html center="-16.50698840086817,-68.1038842231085" zoom="3" basemap="Esri_WorldPhysical" caption="Meso- and South-America" geojson="cassava_leaves.json~Cassava leaves" class="right" %}
...
{% include embed/image.html src="Jar-depicting-the-botanical-frog.jpg" aspect="0.8" class="right" %}
{% include embed/image.html src="Cassava_tuber_ground_Flickr.jpg" aspect="0.9" class="right" %}
{% include embed/image.html src="457658938.jpg" caption="Rayed figure in a litter carried by anthropomorphic warriors. Drawing reproduces iconography on the body of a ceramic vessel held by the Ethnologisches Museum Berlin. To the left of the figure in the dais are anthropomorphic fox, feline, maize or corn plant known as the Botanical Frog. Harvard University, Dumbarton Oaks Research Library." source="https://iiif.lib.harvard.edu/manifests/ids:457658938" aspect="2.48" class="right" %}
...
{% include embed/image.html manifest="Saliva_Indian_Women_Making_Cassava_Bread,_Province_of_Casanare.yaml" class="right" %}
...
{% include embed/image.html src="Cassava_grater_medium.jpg" aspect="0.78" class="right" %}
{% include embed/image.html src="012.700x700.jpg" aspect="1.52" class="right" %}
{% include embed/image.html src="cassava-4.jpg" aspect="2.72" class="right" %}
...
{% include embed/image.html src="4989873.jpg" aspect="0.79" class="right" %}
{% include embed/image.html src="4989868.jpg" aspect="0.74" class="right" %}
...
{% include embed/map.html center="-7.9364,-14.3925" zoom="2.3" basemap="Esri_WorldPhysical" caption="World map with arrows indicating mobility of cassava." geojson="distribution_arrows.json~Mobility of cassava|GreaterAntilles_Haiti_Barbados.json~Greater Antilles including Haiti, and Barbados" class="right" %}
...
{% include embed/map.html center="19.1981,-71.06222" zoom="5.2" basemap="Esri_WorldPhysical" caption="Greater Antilles (yellow) including Haiti (purple), and Barbados (magenta)." geojson="GreaterAntilles_Haiti_Barbados.json~Greater Antilles including Haiti, and Barbados" class="right" %}
...
{% include embed/image.html src="481769537_16.jpg" caption="Merian, Maria Sibylla, 1647-1717. Metamorphosis insectorum Surinamensium. French & Latin. Dissertatio de generatione et metamorphosibus insectorum Surinamensium. Amstelaedami : Apud Joannem Oosterwyk, 1719. RARE RBR K-ROLLER-3-3 MERIA. Dumbarton Oaks Research Library, Washington, D.C." source="https://iiif.lib.harvard.edu/manifests/drs:481769537 seq=16" aspect="0.76" class="right" %}
...
{% include embed/image.html src="481769537_154.jpg" caption="Merian, Maria Sibylla, 1647-1717. Metamorphosis insectorum Surinamensium. French & Latin. Dissertatio de generatione et metamorphosibus insectorum Surinamensium. Amstelaedami : Apud Joannem Oosterwyk, 1719. RARE RBR K-ROLLER-3-3 MERIA. Dumbarton Oaks Research Library, Washington, D.C." source="https://iiif.lib.harvard.edu/manifests/drs:481769537 seq=154" aspect="0.77" class="right" %}
{% include embed/image.html src="philosophicaltra01royarich_0262.jpg" aspect="0.65" class="right" %}
{% include embed/image.html src="philosophicaltra01royarich_0264.jpg" aspect="0.65" class="right" %}
...
{% include embed/image.html src="questionmoralsie00lenp_0007.jpg" aspect="0.71" class="right" %}
{% include embed/image.html src="questionmoralsie00lenp_0271.jpg" aspect="0.73" class="right" %}
{% include embed/image.html src="questionmoralsie00lenp_0134.jpg" aspect="0.76" class="right" %}
...
{% include embed/image.html src="Recueildeplancht1Dide_0125.jpg" aspect="0.59" class="right" %}
{% include embed/image.html src="V0044465.jpg" aspect="0.60" class="right" %}
...
{% include embed/image.html src="Cassava_distribution_map_4.jpg" region="2188,991,1452,1275" aspect="1.98" class="right" %}
...
{% include embed/image.html src="IIT_weeded_cassava_field_Nigeria_Flickr.jpg" caption="International Institute of Tropical Agriculture, _Weeded cassava field at Owiwi, Abeokuta, Nigeria_, November 3, 2012." attribution="Flickr, CC BY-NC 2.0" cover="None" aspect="1.33" class="right" %}
...
{% include embed/image.html src="Screen_Shot_2021-01-06_at_12.02.11_PM.jpg" caption="Production of Cassava, after Food and Agriculture Organization of the United Nations." aspect="1.68" class="right" %}
{% include embed/image.html src="41597_2020_501_Fig1_HTML.jpg" caption="Disaggregated cassava production in sub-Saharan Africa and associated data sources. Density of cassava production layer (tonnes per approx. 1 km2) (a). Cassava production data sources and administrative resolution of production census data in each of the countries (b): FAO (fao.org/faostat), Resakss (resakss.org), Agro-MAPS (kids.fao.org/agromaps/) and IITA (personal correspondence with the International Institute of Tropical Agriculture in Ibadan, Nigeria). Basemap source: Esri, DeLorme, HERE, MapmyIndia." region="pct:0,6,100,94" aspect="1.90" class="right" %}
...
{% include embed/image.html src="wc:Making_fufu_Democratic_Republic_Congo.jpg" caption="_Fufu_ being made in the Democratic Republic of Congo." aspect="0.75" class="right" %}
{% include embed/image.html src="CassavaProc_RootsTubersBananas_Mural_Flickr.jpg" caption="Cassava processing in Benin, wall mural, March 7, 2015." cover="None" aspect="1.5" class="right" %}
...
{% include embed/image.html src="Crosby_Cassava_Mural_Flickr.jpg" aspect="1.47" class="right" %}
...
{% include embed/image.html src="15.09.047_NA12_Cassava Garden_2015.jpg" caption="Njideka Akunyili Crosby, Cassava Garden, 2015, Acrylic, transfers, colored pencil, charcoal and commemorative fabric on paper, 72 x 60 in, 182.88 x 152.40 cm" aspect="0.83" class="right" %}
