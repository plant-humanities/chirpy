...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/okra
image:
...
{% include embed/youtube.html id="pS589zKAlnY" caption="The Fighting Okra" aspect="1.6" class="right" %}
...
{% include embed/image.html src="profdrthomsflora03thom_0644.jpg" caption="Flora von Deutschland" description="Botanical illustration from Thomé's Natural History" license="CC BY-SA 4.0" aspect="0.65" class="right" %}
...
{% include embed/image.html src="1_20210320_20210320_0857_0111.jpg" caption=" الجامع لمفردات الأدوية والأغدية إبن البيطار, كتب طبية طب بديل" aspect="0.66" class="right" %}
...
{% include embed/image.html src="wc:Navio_negreiro_-_Rugendas_1830.jpg" caption="Scene from the Middle Passage from *Navio negreiro* by Johann Moritz Rugendas" aspect="0.67" class="right" %}
...
{% include embed/map.html center="6.66461,-34.45313" zoom="2" caption="Migration from Africa to the Southern States" markers="|" geojson="American_South_Overlay.json|arrows.json" class="right" %}
...
{% include embed/image.html src="wc:Slave_quarters_on_a_sugar_Plantation_Wellcome_L0045265.jpg" caption="Slave quarters in a habitation in Martinique, by Jules Boilly, 1826" aspect="1.25" class="right" %}
...
{% include embed/image.html src="wc:Thomas_Jefferson's_Monticello.JPG" caption="Jefferson's Monticello Plantation in Virginia" aspect="1.9" class="right" %}
...
{% include embed/image.html src="wc:Mrs._David_Meade_Randolph,_head-and-shoulders_portrait,_right_profile_LCCN2007677865.jpg" caption="Mary Randolph, author of the *The Virginia House-Wife*" aspect="0.91" class="right" %}
...
{% include embed/image.html src="wc:George_Washington_Carver_c1910_-_Restoration.jpg" caption="A Portrait of George Washington Carver" aspect="0.8" class="right" %}
...
{% include embed/image.html src="wc:Okra_in_Margarita_Island.jpg" caption="Okra growing on Margarita Island" aspect="0.66" class="right" %}
...
{% include embed/image.html src="wc:Praline_Connection_New_Orleans_Sept_2018_Fried_Okra.jpg" caption="A New Orleans Style Fried Okra" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Gumbo_in_the_Pot.jpg" caption="Gumbo" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Gullah_s_carolina_1790.jpg" caption="Protrayal of Enslaved Gullah People" aspect="1.55" class="right" %}
...
{% include embed/image.html src="wc:Abelmoschus_moschatus_Medik._(AM_AK28139).jpg" caption="Herbarium Specimen of Okra" aspect="0.75" class="right" %}
