...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/peony
image:
  path: wc:Smith_-_Chinese_Tree_Peony_%28Paeonia_suffruticosa%29_-_1939.288_-_Cleveland_Museum_of_Art.jpg
---
...
{% include embed/image.html src="img1_1_4.jpg" source="https://theme.npm.edu.tw/exh105/npm_anime/TwelveMonths/common/images/selection/img1_1_4.jpg" aspect="0.57" class="right" %}
{% include embed/map.html id="map1" center="Q187136" zoom="4" geojson="Song.json~The Song dynasty at its greatest extent in 1111 AD." class="right" %}
...
{% include embed/image.html src="si-FS-7258_37.jpg" aspect="0.69" class="right" %}
...
{% include embed/image.html src="wc:Camille_Pissarro_-_Bouquet_of_pink_Peonies_-_Ashmolean_Museum.jpg" caption="Camille Pissarro, A Bouquet of Pink Peonies, 1873, Ashmolean Museum, Wikimedia Commons, public domain" region="0,124,1084,909" aspect="0.81" class="right" %}
...
{% include embed/map.html center="41.17816,84.50213" zoom="1.5" geojson="peony.json~Peony Distribution" class="right" %}
...
{% include embed/image.html src="10.5555_al.ap.specimen.m0153623.jpg" aspect="0.66" class="right" %}
{% include embed/image.html src="10.5555_al.ap.specimen.k000687216.jpg" aspect="0.62" class="right" %}
...
{% include embed/image.html src="wc:Ming_herbal_(painting);_Chinese_herbaceous_peony_Wellcome_L0039426.jpg" caption="Ming herbal (painting): Chinese herbaceous peony" aspect="0.67" class="right" %}
...
{% include embed/image.html src="gri_33125014246561_1145.jpg" caption="Mattioli, i discorsi, pg. 964" aspect="0.75" class="right" %}
{% include embed/image.html src="gri_33125014246561_1146.jpg" caption="Mattioli, i discorsi, pg. 965" aspect="0.71" class="right" %}
...
{% include embed/image.html src="herbarionuouo00dura_0357.jpg" caption="Durante, pg. 341" aspect="0.68" class="right" %}
{% include embed/image.html src="gri_33125012606592_1023.jpg" caption="Gerard, pg. 980" aspect="0.72" class="right" %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1kjtI9t7HgoZRiDeDyGjXXabVm2b3nZqTYFxnmxQUFFI&timenav-position=bottom&hash-bookmark=false&initial-zoom=1&height=500" class="right" %}
...
{% include embed/image.html src="wl-L0038032.jpg" caption="Theory of diseases treated with decoction of Radix Puerariae, Wellcome Collection." aspect="0.67" class="right" %}
...
{% include embed/image.html src="Calcium-Channel-Blocker.jpg" caption="Treating diseased brain cells with calcium channel blockers" attribution="University of Bristol" aspect="1.25" class="right" %}
...
{% include embed/map.html center="47.61128698661441,8.433186816910375" zoom="5" caption="Recipients of Anna Maria Luisa’s Infant Convulsion Powder" geojson="AML_distribution.json~Distribution of Anna Maria Luisa’s Infant Convulsion Powder" class="right" %}
