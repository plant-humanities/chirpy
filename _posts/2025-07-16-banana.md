...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/banana
image:
...
{% include embed/image.html src="Banana_Languages.jpg" aspect="1.09" class="right" %}
...
{% include embed/image.html src="wc:Greater_Indian_fruit_bat_@_Kanjirappally_02.jpg" aspect="1.39" class="right" %}
...
{% include embed/image.html src="Domestication_of_the_banana.jpg" aspect="0.75" class="right" %}
...
{% include embed/image.html src="From_Diploid_to_Triploid_new.jpg" caption="From Diploids to Triploids." aspect="1.27" class="right" %}
...
{% include embed/map.html center="10.83213,117.24609" zoom="3" basemap="Esri_WorldPhysical" caption="Geographical distribution of _Musa balbisiana_ and subspecies of _Musa acuminata_" geojson="M_accuminata_subspecies.json" class="right" %}
...
{% include embed/image.html manifest="c25fa141a470ac070cc8bc6243c447f91f12c2711a843ac3d571c0159ef513c9.yaml" aspect="" class="right" %}
 -->
...
{% include embed/image.html src="V0043033.jpg" aspect="0.73" class="right" %}
...
{% include embed/image.html src="41598_2016_Article_BFsrep31586_Fig1_HTML.jpg" region="0,3,1050,809" aspect="0.79" class="right" %}
...
{% include embed/map.html center="9.45008,78.39844" zoom="2" basemap="Esri_WorldPhysical" caption="Origins of Banana" geojson="banana_distribution.json" class="right" %}
...
{% include embed/map.html center="-10.46319,-29.53125" zoom="2" basemap="Esri_WorldPhysical" caption="Voyage of Bartolomeu Dias (1487-88)" geojson="bananas_africa.json" class="right" %}
...
{% include embed/map.html center="Q1171" zoom="7" basemap="Esri_WorldPhysical" caption="Goa" class="right" %}
...
{% include embed/map.html center="37.16223,27.07031" zoom="3" basemap="Esri_WorldPhysical" caption="Medieval Venetian Commerical Traderoutes" geojson="Banana_Islamic_Empire.json" class="right" %}
...
{% include embed/image.html src="U91y-xxk0OYC&hl_PA185.jpg" aspect="0.62" class="right" %}
{% include embed/image.html src="6726349.jpg" region="pct:45.06,5.74,46.75,46.79" aspect="0.61" class="right" %}
...
{% include embed/map.html center="7.71371,12.65625" zoom="1" basemap="Esri_WorldPhysical" caption="Early Modern Names for Banana" geojson="banana_names.json" class="right" %}
...
{% include embed/map.html center="-0.4765,-80.8117" zoom="2.5" basemap="Esri_WorldPhysical" caption="Distribution of Banana in the New World by the 17th Century" geojson="banana_distribution_LA.json~Banana Distribution in Central and South America" class="right" %}
...
{% include embed/image.html src="wc:Plantain_banana_(Musa_x_paradisiaca_L.);_nine_sections_of_fl_Wellcome_V0042994.jpg" aspect="0.65" class="right" %}
...
{% include embed/image.html src="Banana_Cart_NYC_1902_LOC.jpg" aspect="1.92" class="right" %}
...
{% include embed/image.html src="United_Fruit_Company_banana_conveyors.jpg" aspect="1.26" class="right" %}
...
{% include embed/map.html center="-13.91408,20.39063" zoom="1" basemap="Esri_WorldPhysical" caption="Distribution of Fusarium wilt of banana (races 1 and 2)" geojson="Fusarium_wilt.json" class="right" %}
...
{% include embed/image.html manifest="f3470082f04ed996a163ba4c60f1f67d87ca3145f154ea9dc0cbfa7a17006db4.yaml" region="-7,1,674,519" aspect="" class="right" %}
-->
...
{% include embed/map.html center="13.91608,14.0625" zoom="1" caption="Top 20 Banana Producing Countries 2012" geojson="top_20_banana_countries.json" class="right" %}
