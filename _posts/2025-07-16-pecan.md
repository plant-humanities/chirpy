...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/pecan
image:
...
{% include embed/image.html src="image0.jpg" caption="Pecans having a disagreement. Courtesy of Allison Caban" description="Pecans discuss how to call themselves" label="Pecans Having a Disagreement, courtesy of Allison Caban" license="Courtesy of Allison Caban" aspect="1" class="right" %}
...
{% include embed/image.html src="wc:Pecan_pie_(8030810481).jpg" caption="Pecan Pie at Thanksgiving" aspect="1.51" class="right" %}
...
{% include embed/image.html src="wc:Starr-110415-5164-Carya_illinoinensis-cracked_seeds_from_tree_at_MISC_HQ_Piiholo-Hawea_Pl_Olinda-Maui_(24455970883).jpg" caption="Cracked pecan shells" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Caddoan_Mississippian_culture_map_HRoe_2010.jpg" caption="Caddoan Mississippian Culture Map" aspect="1.29" class="right" %}
...
{% include embed/image.html src="wc:Expedition_Cabeza_de_Vaca_Karte.png" caption="Map of Cabeza de Vaca Expedition" aspect="2.21" class="right" %}
...
{% include embed/image.html src="wc:A_plan_of_the_several_villages_in_the_illinois_country.png" caption="Illustrated Map of Mississippi River and Kaskaskia Village" aspect="0.6" class="right" %}
...
{% include embed/image.html src="52292046.jpg" caption="Pecan Illustration" description="André Michaux's *Trees of North America*" label="Pecan Illustration from André Michaux's *Trees of North America*" source="https://www.biodiversitylibrary.org/pageImage/52292046" aspect="0.55" class="right" %}
...
{% include embed/image.html src="wc:Cherry_tree_grafting_3.jpg" caption="Tree grafting" aspect="1" class="right" %}
...
<!-- image not loading
{% include embed/image.html src="https://cgru.usda.gov/CARYA/PECANS/01/cent-tr02.jpg" caption="A photo of one of Antoine's pecan trees" description="Photo of one of Antoine's trees" label="Antoine's Pecan Tree" license="CC0" aspect="0.74" class="right" %}
-->
...
{% include embed/image.html src="wc:St._James_Parish_-_Oak_Alley_Plantation_-_20220730134916.jpg" caption="Living quarters for the enslaved at Oak Alley Plantation" rotation="180" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Centennial_Exhibition,_Opening_Day.jpg" caption="Centennial Exposition in Philadelphia, 1876" aspect="1.64" class="right" %}
...
{% include embed/image.html src="wc:Louisiana_-_U.S._Department_of_Agriculture_Exprimental_Pecan_Farm_-_NARA_-_23940505.jpg" caption="US Department of Agriculture's Experimental Pecan Farm in Louisiana, 1917-1964" aspect="1.30" class="right" %}
...
{% include embed/image.html src="CAT31332999_0006.jpg" aspect="0.66" class="right" %}
...
{% include embed/image.html src="CAT31290349_0005.jpg" aspect="0.65" class="right" %}
...
{% include embed/image.html src="EmmaT960x540.jpg" caption="Emma Tenayuca leading fellow workers" description="Labor Activist" label="Emma Tenayuca Leading Fellow Workers" license="Fair Use" source="https://www.peoplesworld.org/wp-content/uploads/2008/03/EmmaT960x540.jpg" aspect="1.78" class="right" %}
...
{% include embed/image.html src="wc:Irrigating_Pecans.jpg" caption="Pecan orchard being irrigated" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Making_turtles.jpg" caption="Candy maker preparing pecans" aspect="0.69" class="right" %}
...
{% include embed/map.html id="map1" center="-19.97335,208.82813" zoom="1" markers="||" class="right" %}
...
{% include embed/image.html src="wc:Yellow_Aphids_(3816108670).jpg" caption="Oleander yellow aphids" aspect="1.78" class="right" %}
...
{% include embed/image.html src="wc:Pecan_Pie%3F.jpg" caption="Young girl serving pecan pie" class="right" %}
