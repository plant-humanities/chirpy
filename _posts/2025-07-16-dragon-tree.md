...
{% include embed/image.html src="923a4fd5cd19774b9251274f6c0edbf8f355bdb575101414f54cff74c404fc4e.jpg" aspect="0.67" class="right" %}
...
{% include embed/image.html src="e1637c277aec8ab1f77a9717561584e57eda0ed96e72f1033f17811858df1552.jpg" aspect="1.11" class="right" %}
...
{% include embed/map.html center="Q105967" zoom="4" basemap="Esri_WorldPhysical" caption="Distribution range of _Dracaena draco_." geojson="Dracaena-draco-native.json" class="right" %}
...
{% include embed/image.html src="04ab805fb5472693deb181faf8b9b47d0f3b1bc6eb5a29c6b2bbeb11e14f.jpg" caption="The Flight into Egypt, first known etching of the Dragon Tree" source="https://jqz7t23pp9.execute-api.us-east-1.amazonaws.com/dev/manifest/751f7/manifest.json" aspect="0.67" class="right" %}
...
{% include embed/image.html src="51906905.jpg" aspect="0.65" class="right" %}
{% include embed/image.html src="56601428.jpg" aspect="0.66" class="right" %}
...
{% include embed/image.html src="DP-1411-001.jpg" caption="Julius Schrader, Baron Alexander von Humboldt (1769–1859), oil on canvas, 1859, Metropolitan Museum of Art, public domain." source="https://images.metmuseum.org/CRDImages/ep/original/DP-1411-001.jpg" aspect="0.87" class="right" %}
{% include embed/image.html src="wc:Map_Alexander_von_Humboldt_expedition-en.svg" aspect="1.49" class="right" %}
{% include embed/image.html src="wc:Berthelot_drago_franchy.jpg" aspect="1.25" class="right" %}
...
{% include embed/image.html src="459304936.jpg" caption="Harvard University, Dumbarton Oaks Research Library, PHPC002_K4464" source="https://iiif.lib.harvard.edu/manifests/ids:459304936" aspect="1.64" class="right" %}
...
{% include embed/image.html src="IMG_9319.jpg" caption="A small outcrop of Dracaena draco trees at the oldest botanical garden on the Canary Islands, the Jardin Botanico Canario Viera y Clavijo in Gran Canaria, Spain. Photo taken by Thomas C. Anderson, July 2019." aspect="0.75" class="right" %}
...
{% include embed/image.html src="2c03226df2f0fdc825a206069fcd2f90653692240d8c0f1733b2e7d981bc.jpg" caption="Dragon Tree at Orotava" source="https://jqz7t23pp9.execute-api.us-east-1.amazonaws.com/dev/manifest/7b1dr/manifest.json" aspect="0.69" class="right" %}
...
{% include embed/image.html src="wc:Orotava_Ayuntamiento_04.jpg" aspect="0.78" class="right" %}
...
{% include embed/image.html src="NMAH-AHB2013q009978.jpg" caption="Eighteenth-century German apothecary jar for dragon’s blood." source="https://ids.si.edu/ids/manifest/NMAH-AHB2013q009978" aspect="0.8" class="right" %}
...
{% include embed/image.html src="wc:Sanguis1.JPG" caption="Dragon’s blood derived from Dracaena cinnabari on the island of Socotra." aspect="1.33" class="right" %}
