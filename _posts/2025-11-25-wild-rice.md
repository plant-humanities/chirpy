...
{% include embed/image.html src="wc:Wild_rice_in_McGregor,_Minnesota.jpg" caption="Wild rice flowers in McGregor, Minnesota." aspect="1.5" class="right" %}
...
{% include embed/image.html src="gh:floraklein/Zizania-palustris/main/wild%20rice/KEW%20POW%20Z%20palustris.jpg" caption="Zizania palustris type specimen" aspect=".74" class="right" %}
{% include embed/image.html src="gh:floraklein/Zizania-palustris/main/wild%20rice/Kew%20POW%20Z%20palustris%20dist.png" caption="Global distribution of Zizania palustris" aspect="3.5" class="right" %}
{% include embed/image.html src="wc:The_book_of_grasses_-_an_illustrated_guide_to_the_common_grasses,_and_the_most_common_of_the_rushes_and_sedges_(1912)_(14576920329).jpg" caption="Zizania aquatica and Zizania palustris" aspect=".65" class="right" %}
...
{% include embed/image.html src="wc:Carl_von_Linné.jpg" caption="Carl Linnaeus (1775)" aspect="0.83" class="right" %}
{% include embed/iframe.html src="https://www.biodiversitylibrary.org/page/42945403page/163/mode/1up" class="right" %}
...
{% include embed/image.html src="wc:Zizania_palustris_15-p.bot-ziza.palus-3.jpg" caption="Zizania palustris" aspect=".98" class="right" %}
{% include embed/image.html src="wc:Wild_Rice_at_sunset_on_Big_Sandy_Lake_in_McGregor,_Minnesota.jpg" caption="Wild Rice at sunset on Big Sandy Lake, McGregor, Minnesota (2021)" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Zizania_palustris_macro.jpg" caption="Zizania palustris" aspect="1.51" class="right" %}

{% include embed/image.html src="wc:Manoomin_picking,_1905,_Minnesota.jpg" caption="Manoomin picking, Minnesota (1905)" aspect="1.6" class="right" %}
...
{% include embed/image.html src="MNdams.jpg" caption="Dams in Minnesota" aspect=".75" class="right" %}
...
{% include embed/image.html src="wc:PehrKalm.jpg" caption="Pehr Kalm (1764)" aspect=".81" class="right" %}
...
{% include embed/image.html src="wc:Carte_des_voyages_du_Cape._Carver,_dans_la_partie_intérieure_de_l'Amérique_septentrionale_en_1766,_et_1767._LOC_74695016.jpg" caption="Map of Carver’s travels in North America (1768)" aspect="1.28" class="right" %}
...
{% include embed/iframe.html src="https://www.biodiversitylibrary.org/page/756477#page/317/" class="right" %}
{% include embed/image.html src="wc:Aylmer_Bourke_Lambert._Stipple_engraving_by_W._Holl,_1805,_a_Wellcome_V0003335.jpg" caption="xxx" aspect="0.73" class="right" %}
{% include embed/image.html src="wc:François_André_Michaux_(1770–1855).jpg" caption="xxx" aspect="0.74" class="right" %}
...
{% include embed/image.html src="wc:Photograph_of_Wilbur_Isaacson_Looking_out_over_the_Wild_Rice_Area_of_Waboose_Bay_-_DPLA_-_0942bc9d8377dda177629e2f35393908.jpg" caption="Photograph of Wilbur Isaacson Looking out over the Wild Rice Area of Waboose Bay (1958)" aspect="1.27" class="right" %}
...
{% include embed/iframe.html src="NL000379_o2.jpg" class="right" %}
{% include embed/image.html src="wc:Wild_rice_harvesting_and_processing_-_NARA_-_285183.jpg" caption="Wild rice harvesting and processing" aspect="1.7" class="right" %}
{% include embed/image.html src="wc:Winnowing_the_wild_rice_in_a_birch_bark_basket.jpg" caption="Winnowing the wild rice in a birch bark basket" aspect="1.5" class="right" %}
{% include embed/image.html src="wc:Parching_the_wild_rice_over_an_open_flame.jpg" caption="Parching the wild rice over an open flame" aspect="1.5" class="right" %}
{% include embed/youtube.html id="SH_YYyw9yF8" aspect="1.8" class="right" %}
{% include embed/youtube.html id="6tjd7H1iQWY" aspect="1.8" class="right" %}
{% include embed/youtube.html id="EFW5QE6ahOU" aspect="1.8" class="right" %}
...
{% include embed/youtube.html id="HvLvwo3a5PU" aspect="1.8" class="right" %}
{% include embed/image.html src="wc:Wild_rice_harvesting_and_processing_-_NARA_-_285183.jpg" caption="Wild rice harvesting and processing" aspect="1.7" class="right" %}
...
{% include embed/iframe.html src="https://tile.loc.gov/storage-services/public/gdcmassbookdig/wildricegatherer00jenk/wildricegatherer00jenk.pdf" class="right" %}
...
{% include embed/image.html src="wc:Z_palustris_in_seed.jpg" caption="Zizania palustris seed" aspect="1.63" class="right" %}
...
{% include embed/youtube.html id="WpfTvLMNqvg" aspect="1.8" class="right" %}
...
{% include embed/image.html src="wild_rice_lakes_dnr.jpg" caption="Wild rice lakes in Minnesota" aspect=".75" class="right" %}
...
{% include embed/image.html src="wc:Wisconsin_Wild_Rice_(31038061852).jpg" caption="Wisconsin Wild Rice" aspect="1.5" class="right" %}
...
{% include embed/youtube.html id="46XHxnjGs4o" aspect="1.8" class="right" %}
...
{% include embed/image.html src="st_louis_watershed.jpg" caption="St. Louis Watershed lakes, wetlands, and peat deposits" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:A_Protect_Wild_Rice_sign_outside_Aitkin_County_Courthouse_in_Aitkin,_Minnesota.jpg" caption="A Protect Wild Rice sign outside Aitkin County Courthouse in Aitkin, Minnesota" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Pipeline_Free_Manoomin_(Honor_the_Earth).jpg" caption="Pipeline Free Manoomin" aspect="0.64" class="right" %}
...
{% include embed/image.html src="wc:2_Protect_Our_Water_No_Line_3_%2B_No_Pesticides_sign_outside_of_Palisade,_Minnesota.jpg" caption="Protect Our Water No Line 3 No Pesticides sign outside of Palisade, Minnesota (2020)" aspect="1.5" class="right" %}
...
{% include embed/image.html src="wc:Chippewa_wild_rice_harvesting.jpg" caption="Wild rice harvesting" aspect="1.5" class="right" %}
{% include embed/image.html src="wc:Processed_wild_rice_at_Wild_Rice_House_in_Finland,_Minnesota_(51432379817).jpg" caption="Processed wild rice at Wild Rice House in Finland, Minnesota" aspect="1.5" class="right" %}
