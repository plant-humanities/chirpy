...
{% include embed/video.html src="SH_YYyw9yF8" aspect="1.8" class="right" %}
{% include embed/video.html src="6tjd7H1iQWY" aspect="1.8" class="right" %}
{% include embed/video.html src="EFW5QE6ahOU" aspect="1.8" class="right" %}
...
{% include embed/video.html src="HvLvwo3a5PU" aspect="1.8" class="right" %}
{% include embed/image.html src="wc:Wild_rice_harvesting_and_processing_-_NARA_-_285183.jpg" caption="Wild rice harvesting and processing" aspect="1.7" class="right" %}
...
{% include embed/video.html src="WpfTvLMNqvg" aspect="1.8" class="right" %}
...
{% include embed/video.html src="46XHxnjGs4o" aspect="1.8" class="right" %}
