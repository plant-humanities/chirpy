...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/turmeric
image:
...
{% include embed/image.html src="48537187.jpg" aspect="0.67" class="right" %}
...
{% include embed/map.html center="15.103853,18.634794" zoom="2" basemap="Esri_WorldPhysical" caption="Former Countries of the British Empire" geojson="british_empire_2.geojson~Former Countries of the British Empire" class="right" %}
...
{% include embed/map.html center="3.150845,101.695570" zoom="3.5" basemap="Esri_WorldPhysical" caption="The Origins of Turmeric" geojson="Origins_Turmeric_2.json~Potential Origins of Turmeric" class="right" %}
...
{% include embed/map.html center="22.056278,78.936964" zoom="4.1" basemap="Esri_WorldPhysical" caption="Indian Subcontinent" geojson="India_Sub.geojson~Indian Subcontinent" class="right" %}
...
{% include embed/map.html center="-0.091300,107.056186" zoom="3.5" basemap="Esri_WorldPhysical" caption="Spread of Turmeric" geojson="Turmeric_Spread.json~Turmeric spreads out" class="right" %}
...
{% include embed/map.html center="28.634609,77.204167" zoom="6.5" caption="Delhi" geojson="delhi.json~Delhi" class="right" %}
...
{% include embed/map.html center="43.320749,11.330224" zoom="6.5" caption="Mattioli's Birthplace" geojson="siena.json~Mattioli's Birthplace" class="right" %}
...
{% include embed/map.html center="51.513184,-0.082066" zoom="5.5" caption="London" geojson="london.json~Pechey's Birthplace" class="right" %}
...
{% include embed/map.html center="51.513184,-0.082066" zoom="8" caption="East India House in London" geojson="East_India_House.json~East India House" class="right" %}
...
{% include embed/image.html src="55999435.jpg" aspect="0.57" class="right" %}
...
{% include embed/image.html manifest="aad07a90276f685369f052ff8465ebecf70f6724c6bf50cb5535fa658ca1e50f.yaml" class="right" %}
-->
...
<!-- Image no longer available
{% include embed/image.html manifest="13271512667e5c835444bee9212cc1f582b824a993d1f975b21ee816f16e9bff.yaml" class="right" %}
-->
...
{% include embed/image.html src="kXsCAAAAYAAJ_PR3.png" aspect="0.64" class="right" %}
{% include embed/image.html src="kXsCAAAAYAAJ_PR11.png" aspect="0.67" class="right" %}
