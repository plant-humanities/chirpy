...
{% include embed/image.html src="wc:Nigeria_Cowpea_fro_F_IITA.jpg" aspect="1.33" class="right" %}

{% include embed/image.html src="wc:Wild_cowpea_flowers_(6930710085).jpg" aspect="1.08" class="right" %}

{% include embed/image.html src="wc:Field_of_Vigna_unguiculata.jpg" aspect="1.33" class="right" %}
{% include embed/image.html src="wc:Vigna_unguiculata_nodules1_(10737516253).jpg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="Herniter_Muñoz-Amatriaín_Close_Proposed_spread_of_cowpea.jpg" aspect="1.87" class="right" %}
...
{% include embed/image.html src="wc:Restes_du_banquet,_mosaïque.jpg" caption="Sosus of Pergamon, after, Banquet leftovers, or Unswept Floor, early 2nd CE, mosaic, 4.05 x 0.41 m, Museum Gregoriano Profano, Vatican." aspect="1.47" class="right" %}
...
{% include embed/image.html src="Annibale_Carracci_Bean_Eater_dvdbramhall_Flickr_CC_BY_NC_ND_2.0.jpg" aspect="1.2" class="right" %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1goBeScMb3Depvqjmo89tMojcRHDbVY4YOktgo-P7oV4" class="right" %}
...
{% include embed/image.html src="Clusius_Rariorum_Plantarum_Historia_Biblioteca_del_Real_Jardín_Botánico_CC_BY_NC_SA.jpg" region="275,48,1380,1253" aspect="0.61" class="right" %}
...
{% include embed/image.html src="Yardlong_bean.jpg" caption="Cowpea [Vigna unguiculata (L.) Walp.], Seikei Zuetsu, vol. 18, Leiden University Library." aspect="0.65" class="right" %}
...
{% include embed/image.html src="al.ap.specimen.bm000589657.jpg" aspect="0.65" class="right" %}
...
{% include embed/image.html src="slaveryinunit00ballcha_0172.jpg" aspect="0.59" class="right" %}
...
{% include embed/image.html src="master-mss-mgw-mgw2-014-2340228.jpg" aspect="0.59" class="right" %}
...
{% include embed/image.html src="wartimesketcheshdimi_0075.jpg" aspect="0.59" class="right" %}
...
{% include embed/image.html src="CAT31355486_0003.jpg" aspect="0.59" class="right" %}
...
{% include embed/image.html src="wc:Imperial_Federation_Map_of_the_World.jpg" aspect="1.35" class="right" %}
...
{% include embed/youtube.html id="R6l8jRF-eGA" caption="A feast of African-American culinary contributions, baked into the South’s DNA" class="right" %}
...
{% include embed/youtube.html id="v7HwKxDus9E" caption="Tiebou yapp niébé" class="right" %}
...
{% include embed/image.html src="wc:Hoppin'_John_at_Brenda's_Meat_&_Three_for_good_luck._San_Francisco,_CA._(39570682392).jpg" aspect="1.33" class="right" %}
{% include embed/image.html src="wc:Hoppin_John.jpg" rotation="90" aspect="0.75" class="right" %}
{% include embed/image.html src="wc:Hoppin'_John.jpg" aspect="1.49" class="right" %}
...
{% include embed/image.html src="wc:فيجوادا_feijoada.jpg" caption="Feijoada with rice, fried kale, cassava starch crisps (biscoito de polvilho), cassava flour (farinha), and a mix of olive oil, alcohol vinegar, tomatoes, onions and sometimes bell peppers called vinagrete." aspect="0.75" class="right" %}
{% include embed/image.html src="wc:Feijoada_à_brasileira_-02.jpg" caption="Feijoada à brasileira." aspect="1.17" class="right" %}
{% include embed/image.html src="wc:Soul_Food_Deli_Shreveport.jpg" caption="P & C Soul Food Deli, Shreveport, Louisiana." aspect="1.50" class="right" %}
...
{% include embed/map.html center="25.19559,17.57813" zoom="1" caption="Map of black-eyed pea distribution showing native range (blue) and introduction (green) (after Kew’s Plants of the World Online)." geojson="Distribution_5.geojson~Distribution" class="right" %}
...
{% include embed/youtube.html id="pqmBsUHSkBg" caption="Beyond the gardens, the crop wild relatives project" aspect="1.6" class="right" %}
