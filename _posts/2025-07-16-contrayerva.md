...
{% include embed/map.html center="4.98477,-182.98311" zoom="0.5" geojson="drake.json~Drake's circumnavigation between 1577 and 1580." class="right" %}
...
{% include embed/image.html src="bhl-58480828.jpg" aspect="0.66" class="right" %}
{% include embed/image.html src="bhl-58480797.jpg" aspect="0.70" class="right" %}
...
{% include embed/image.html src="bhl-58480796.jpg" aspect="0.66" class="right" %}
...
{% include embed/map.html center="-9.130550123807534,-70.78263840714388" zoom="3.5" geojson="pre_conquest.json~Map of Latin America displaying the approximate regional footprint of indigenous populations prior to Spanish conquests." class="right" %}
...
<!-- Broken image
{% include embed/image.html src="https://content.wdl.org/10096/service/thumbnail/1431369762/1024x1024/3/602.jpg" aspect="" class="right" %}
-->
...
{% include embed/image.html src="Florentine_Codex_Open.jpg" aspect="1.56" class="right" %}
...
{% include embed/image.html src="FC_Coanenepilli.jpg" aspect="1.50" class="right" %}
...
{% include embed/image.html src="bhl-55231362.jpg" region="1,166,2566,2192" aspect="0.74" class="right" %}
{% include embed/image.html src="bhl-42728883.jpg" aspect="0.74" class="right" %}
...
{% include embed/image.html src="10.5555_al.ap.specimen.br0000013080891.jpg" aspect="0.60" class="right" %}
{% include embed/image.html src="10.5555_al.ap.specimen.p00307405.jpg" aspect="0.63" class="right" %}
{% include embed/image.html src="10.5555_al.ap.specimen.e00413821.jpg" aspect="0.61" class="right" %}
...
{% include embed/image.html src="bhl-40358907.jpg" aspect="0.57" class="right" %}
{% include embed/image.html src="bhl-40289149.jpg" aspect="0.57" class="right" %}
...
{% include embed/map.html center="19.435,-99.131389" zoom="5" geojson="Nahua.json" class="right" %}
...
{% include embed/image.html src="Contrayerva_specimen.jpg" aspect="0.69" class="right" %}
...
{% include embed/image.html src="4241393.jpg" source="https://digital.ub.uni-duesseldorf.de/download/webcache/2000/4241393" aspect="0.82" class="right" %}
...
{% include embed/image.html src="Fever_water.jpg" aspect="1.24" class="right" %}
...
{% include embed/image.html src="bhl-673094.jpg" aspect="0.71" class="right" %}
...
{% include embed/image.html src="wc:Dorstenia_contrajerva.jpg" region="0,2190,4012,3474" aspect="0.63" class="right" %}
