...
{% include embed/image.html src="wc:Bulgarian_watermelon.JPG" aspect="1.33" class="right" %}
...
{% include embed/image.html src="GBIF_Kalahari_watermelon_copyright_unknown.png" caption="Kalahari watermelon. GBIF, https://api.gbif.org/, copyright unknown." region="194,69,1707,1263" aspect="1.54" class="right" %}
...
{% include embed/image.html src="459932909.jpg" caption="Jombert, Charles Antoine, 1712-1784. Les delices de Versailles et des maisons royales, ou, Recueil de vues perpectives des plus beaux endroits des châteaux, parcs, jardins, fontaines & bosquets de Versailles, la Ménagerie, Trianon, Marly, Meudon, Saint-Cloud, Fontainebleau, Chantilly, Sceaux, Maisons &c. MDCCLXVI [1766].  RARE RBR O-2-5 JOM. Dumbarton Oaks Research Library, Washington, D.C." region="pct:19.20,17.88,63.41,10.46" aspect="1" class="right" %}
{% include embed/image.html src="mobot31753000819224_0513.jpg" aspect="0.55" class="right" %}
...
{% include embed/image.html src="Albucasis_Observations_sur_la_nature_btv1b105380445.jpg" aspect="0.73" class="right" %}
{% include embed/image.html src="mobot31753000817756_0950.jpg" aspect="0.60" class="right" %}
...
{% include embed/image.html src="20430850.jpg" caption="C. Bennette Moore, Untitled (two children eating watermelon), c. 1935, negative, gelatin silver (film), 10.16 x 12.7 cm." attribution="Harvard Art Museums" license="Copyright © President and Fellows of Harvard College" aspect="1.25" class="right" %}
...
{% include embed/image.html src="DP-12232-006.jpg" aspect="0.75" class="right" %}
{% include embed/image.html src="18731783.jpg" caption="Plants and insects by Shin Saimdang." attribution="Harvard Art Museums" aspect="0.76" class="right" %}
{% include embed/image.html src="wc:5000_won_serieV_reverse.jpeg" aspect="2.09" class="right" %}
...
{% include embed/image.html src="wc:Albert_Eckhout_1610-1666_Brazilian_fruits.jpg" caption="‘Pineapple, watermelons and other fruits (Brazilian fruits)’ by Albert Eckhout (1610–1666)." region="87,334,1667,1233" aspect="0.99" class="right" %}
{% include embed/image.html src="wc:Giovanni_Stanchi,_Watermelons,_Peaches,_Pears,_and_Other_Fruit_in_a_Landscape.jpg" caption="‘Watermelons, peaches, pears and other fruit in a landscape’ by Giovanni Stanchi (1608–1675)." aspect="1.38" class="right" %}
{% include embed/image.html src="wc:Still_Life_with_Watermelon,_by_Sarah_Miriam_Peale,_1822,_oil_on_panel_-_Fogg_Art_Museum,_Harvard_University_-_DSC01409.jpg" caption="‘Still life with watermelons’ by Sarah Miriam Peale (1800–1855)." region="45,108,2088,1544" aspect="1.44" class="right" %}
...
{% include embed/image.html src="wc:African_Americans_dancing_around_a_pile_of_watermelons_(cropped).jpg" aspect="1.75" class="right" %}
...
{% include embed/image.html src="NMAAHC-6A6EEDA3268C2_2001.jpg" caption="Richard Felton Outcault, Postcard depicting a caricatured boy eating a slice of watermelon, 1909, ink on paper, 8.9 x 14 cm." attribution="National Museum of African American History & Culture" license="Public domain. Usage conditions apply" aspect="1.45" class="right" %}
{% include embed/image.html src="NMAAHC-E57085A629442_4002-000002.jpg" caption="Ashtray in the form of a &quot;picaninny&quot; boy eating a watermelon slice, 1920–1929, ceramic, 10.2 x 12.1 x 14 cm." attribution="National Museum of African American History & Culture" license="No Known Copyright Restrictions. Usage conditions apply" aspect="1.11" class="right" %}
{% include embed/image.html src="3_African_American_boys_LOC_No_known_restrictions_on_publication.jpg" caption="[3 African American boys eating watermelon], ca. 1902, photographic print. Photo copyrighted by F.W. Guerin, St. Louis." attribution="Library of Congress Prints and Photographs Division" aspect="1.25" class="right" %}
...
{% include embed/image.html src="8e036f50a495b55cf479e34d4a9dd4a56f171d8fac6c1165862237271433.jpg" aspect="1.15" class="right" %}
...
{% include embed/image.html src="wc:Cholera_395.1.jpg" caption="1849 Cholera prevention poster by the Sanatory Committee, under the sanction of the Medical Counsel, in New York City, published between c. 1830 and c. 1840." aspect="1.47" class="right" %}
...
{% include embed/image.html src="0faea65ea08620dd489e7f49d6653b6fefa8c0f0d33767d6faad2a039885.jpg" aspect="1.38" class="right" %}
...
{% include embed/image.html src="wc:Square_watermelon.jpg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Yangzhou_-_supermarket_-_watermelons_-_P1070029.JPG" aspect="1.33" class="right" %}
...
{% include embed/image.html src="1486001.jpg" caption="Children sitting on a bench outdoors, eating watermelon. Anonymous photograph, c. 1940–1950." aspect="1.5" class="right" %}
