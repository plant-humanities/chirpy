...
published: true
media_subpath: https://raw.githubusercontent.com/plant-humanities/chirpy/main/assets/indigo
image:
...
{% include embed/image.html src="wc:Indus_Valley_Civilization,_Mature_Phase_(2600-1900_BCE).png" aspect="1.23" class="right" %}
...
{% include embed/image.html src="wc:Caricature_gillray_plumpudding.jpg" aspect="1.4" class="right" %}
...
{% include embed/map.html center="17.620068,-71.562101" zoom="5" markers="~Haiti" class="right" %}
...
{% include embed/image.html src="388-4.jpg" caption="Indigo Production, French West Indies, 1667" description="from Histoire Générale des Antilles Habitées par les Francois (1667–1671)." license="Public domain" source="https://si.regeneratedidentities.org/project/DataFiles/SI-OB-388/388-4.jpg" aspect="1.57" class="right" %}
...
{% include embed/image.html src="artdelindigotie00Beau_0135.jpg" aspect="0.57" class="right" %}
...
{% include embed/image.html src="wc:Main_House,_Snee_Farm,_Mount_Pleasant,_SC_-_50738315566.jpg" aspect="1.33" class="right" %}
...
{% include embed/map.html center="32.818369,-79.929117" zoom="11" caption="Charleston, South Carolina" markers="~Charles Pinckney National Historic Site" geojson="SCgeo.json~South Carolina" class="right" %}
...
{% include embed/image.html src="wc:20-Group-of_Indigo-beaters.jpg" aspect="1.25" class="right" %}
...
{% include embed/image.html src="54027-h.jpg" caption="Nil Darpan; or, the Indigo Planting Mirror" description="Front page of Nil Darpan, 1861 English translation" license="Public Domain" source="https://www.gutenberg.org/files/54027/54027-h/images/cover.jpg" aspect="0.58" class="right" %}
...
{% include embed/iframe.html src="https://books.google.com/books?id=q5ZeAAAAcAAJ&pg=PP5&output=embed" aspect="0.62" class="right" %}
...
{% include embed/image.html src="wc:Indigo_factory_bengal2_(1).jpg" aspect="1.35" class="right" %}
...
{% include embed/image.html src="wc:Stamp_of_India_-_2017_-_Colnect_700591_-_Centenary_of_the_Champaran_Indigo_Farmers_Satyagraha.jpeg" aspect="1.33" class="right" %}
...
{% include embed/image.html src="wc:Clipping_of_Denim_Pant.JPG" aspect="" class="right" %}
...
{% include embed/image.html src="wc:Pamela_Ferrell_on_set_Film_Daughters_of_the_Dust_in_1989.png" aspect="0.98" class="right" %}
...
{% include embed/image.html src="wc:Zeugfärberei_Gutau_Blaufärbung_von_Textilien.jpg" aspect="1.52" class="right" %}
...
{% include embed/image.html src="04336021.jpg" caption="NYBG Indigo Specimen" description="From the African American Garden." license="Public domain" source="https://sweetgum.nybg.org/images3/4088/968/04336021.jpg" aspect="0.68" class="right" %}
...
{% include embed/image.html src="wc:Tissages_de_coton_indigo_01.jpg" aspect="1.50" class="right" %}
...
{% include embed/image.html src="wc:Indigo-guizhou.jpg" aspect="1.33" class="right" %}
